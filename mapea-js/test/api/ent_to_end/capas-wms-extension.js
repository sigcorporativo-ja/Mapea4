...
module.exports = {
  ...
  'Comparamos BBOX y MaxExtent para una capa WMS base y otra Overlay': (browser) => {
    browser
      ...
      .execute('return mapjs.getResolutions()', [], function({ value }) {
        assert.deepEqual(value, [703.2340291476141, 351.61701457380707, 175.80850728690353, 87.90425364345177, 43.952126821725884, 21.976063410862942, 10.988031705431471, 5.4940158527157354, 2.7470079263578677, 1.3735039631789339, 0.6867519815894669, 0.34337599079473347, 0.17168799539736673, 0.08584399769868337, 0.04292199884934168, 0.02146099942467084]);
      })
      .end(() => server.close());
  },
};
