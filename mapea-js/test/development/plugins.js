...
const urlGeoserver = 'https://ws096.juntadeandalucia.es/geoserver/';
mapjs.addPlugin(plugins);
const tumbas = new M.layer.GeoJSON({
  name: 'Acceso tumbas',
...
const tumbasSTY = new M.style.Polygon({
  fill: {
    color: '#32515B',
    opacity: 0.8,
  },
