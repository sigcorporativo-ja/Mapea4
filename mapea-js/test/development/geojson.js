...
// Prueba con un feature adicional
layer.once('load', () => {
  const f = new Feature('feature', {
    ...
    geometry: {
      type: 'Point',
      coordinates: [370500, 4276700], // no visible con prueba de setSource
      // coordinates: [-5.5810546875, 36.19995805932895],
    },
  });
  layer.addFeatures(f);
}); // */
