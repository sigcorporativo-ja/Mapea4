...
(function (window) {
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::25830', prj25830);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#25830', prj25830);
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::23030', prj23030);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#23030', prj23030);
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::4258', prj4258);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#4258', prj4258);
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::25829', prj25829);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#25829', prj25829);
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::23029', prj23029);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#23029', prj23029);
  ...
  ol.proj.projections.add('urn:ogc:def:crs:EPSG::4230', prj4230);
  ol.proj.projections.add('http://www.opengis.net/gml/srs/epsg.xml#4230', prj4230);
