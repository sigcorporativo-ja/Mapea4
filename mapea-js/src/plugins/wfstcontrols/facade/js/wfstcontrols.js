...
M.plugin.WFSTControls = (function (controls, layername) {
   ...
   * @api stable
   */
  this.name = M.plugin.WFSTControls.NAME;
 ...
 * @api stable
 */
M.plugin.WFSTControls.prototype.equals = function (plugin) {
  if (plugin instanceof M.plugin.WFSTControls) {
    return true;
  }
  else {
    return false;
 ...
 * @api stable
 */
M.plugin.WFSTControls.NAME = 'wfstcontrols';
