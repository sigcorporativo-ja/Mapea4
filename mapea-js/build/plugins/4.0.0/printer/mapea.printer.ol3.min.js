...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",k=e[g]||"",l=/(\d*)(\D*)/g,r=/(\d*)(\D*)/g;do{var n=l.exec(h)||["","",""],p=r.exec(k)||["","",""];if(0==n[0].length&&0==p[0].length)break;var c=0==n[1].length?0:parseInt(n[1],10),m=0==p[1].length?0:parseInt(p[1],10),c=goog.string.compareElements_(c,m)||goog.string.compareElements_(0==n[2].length,0==p[2].length)||
goog.string.compareElements_(n[2],p[2])}while(0==c)}return c};goog.string.compareElements_=function(a,b){return a<b?-1:a>b?1:0};goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};goog.string.toNumber=function(a){var b=Number(a);return 0==b&&goog.string.isEmptyOrWhitespace(a)?NaN:b};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var P={control:{}};P.control.Printer={};
...
M.config.geoprint.FORCE_SCALE);M.utils.isNullOrEmpty(this.options_.legend)&&(this.options_.legend=M.config.geoprint.LEGEND);a=new M.impl.control.Printer;M.Control.call(this,a)};goog.inherits(M.control.Printer,M.Control);M.control.Printer.prototype.createView=function(a){var b=this;return new Promise(function(a,d){b.getCapabilities().then(function(d){var f=0,g,f=0;for(g=d.layouts.length;f<g;f++){var h=d.layouts[f];if(h.name===b.options_.layout){h.default=!0;break}}f=0;for(g=d.dpis.length;f<g;f++)if(h=
d.dpis[f],h.value==b.options_.dpi){h.default=!0;break}f=0;for(g=d.outputFormats.length;f<g;f++)if(h=d.outputFormats[f],h.name===b.options_.format){h.default=!0;break}d.forceScale=b.options_.forceScale;M.template.compile(M.control.Printer.TEMPLATE,{jsonp:!0,vars:d}).then(function(d){b.addEvents(d);a(d)})})})};M.control.Printer.prototype.addEvents=function(a){this.element_=a;this.inputTitle_=this.element_.querySelector(".form div.title > input");this.areaDescription_=this.element_.querySelector(".form div.description > textarea");
...
c){var d=M.utils.concatUrlPaths([a.url_,"info.json"]);M.remote.get(d).then(function(a){var c={};try{c=JSON.parse(a.text)}catch(d){}b(c)})})}return this.capabilitiesPromise_};M.control.Printer.prototype.setLayout=function(a){this.layout_=a};M.control.Printer.prototype.setFormat=function(a){this.format_=a};M.control.Printer.prototype.setDpi=function(a){this.dpi_=a};M.control.Printer.prototype.setForceScale=function(a){this.forceScale_=a};M.control.Printer.prototype.printClick_=function(a){a.preventDefault();
var b=this;this.getCapabilities().then(function(a){b.getPrintData().then(function(d){var e=M.utils.addParameters(a.createURL,"mapeaop=geoprint"),f=b.createQueueElement();goog.dom.appendChild(b.queueContainer_,f);goog.dom.classlist.add(f,M.control.Printer.LOADING_CLASS);M.remote.post(e,d).then(function(a){goog.dom.classlist.remove(f,M.control.Printer.LOADING_CLASS);if(!0!==a.error){var c;try{a=JSON.parse(a.text),c=a.getURL}catch(d){}f.setAttribute(M.control.Printer.DOWNLOAD_ATTR_NAME,c);goog.events.listen(f,
goog.events.EventType.CLICK,b.dowloadPrint,!1,f)}else M.dialog.error("Se ha producido un error en la impresi\u00f3n")})})})};M.control.Printer.prototype.getPrintData=function(){var a=this.inputTitle_.value,b=this.areaDescription_.value,c=this.map_.getProjection(),d=M.utils.extend({units:c.units,srs:c.code,layout:this.layout_.name,dpi:this.dpi_.value,outputFormat:this.format_},this.params_.layout),e=this;return this.encodeLayers().then(function(c){d.layers=c;d.pages=e.encodePages(a,b);!0===e.options_.legend&&
(d.legends=e.encodeLegends());return d})};M.control.Printer.prototype.encodeLayers=function(){var a=this.map_.getLayers().filter(function(a){return!0===a.isVisible()&&!0===a.inRange()}),b=a.length,c=this;return new Promise(function(d,e){var f=[];a.forEach(function(a){this.getImpl().encodeLayer(a).then(function(a){null!==a&&f.push(a);b--;0===b&&d(f)})},c)})};M.control.Printer.prototype.encodePages=function(a,b){var c=[];M.utils.isArray(this.params_.pages)||(this.params_.pages=[this.params_.pages]);
this.params_.pages.forEach(function(d){d=M.utils.extend({title:a,printTitle:a,printDescription:b},d);if(!1===this.forceScale_){var e=this.map_.getBbox();d.bbox=[e.x.min,e.y.min,e.x.max,e.y.max]}else!0===this.forceScale_&&(e=this.map_.getCenter(),d.center=[e.x,e.y],d.scale=this.map_.getScale());d.rotation=0;c.push(d)},this);return c};M.control.Printer.prototype.encodeLegends=function(){var a=[];this.map_.getLayers().forEach(function(b){!0===b.isVisible()&&!0===b.inRange()&&(b=this.getImpl().encodeLegend(b),
null!==b&&a.push(b))},this);return a};M.control.Printer.prototype.createQueueElement=function(){var a=goog.dom.createElement("li"),b=this.inputTitle_.value;M.utils.isNullOrEmpty(b)&&(b=M.control.Printer.NO_TITLE);a.innerHTML=b;return a};M.control.Printer.prototype.dowloadPrint=function(a){a.preventDefault();a=this.getAttribute(M.control.Printer.DOWNLOAD_ATTR_NAME);M.utils.isNullOrEmpty(a)||window.open(a,"_blank")};M.control.Printer.prototype.equals=function(a){var b=!1;a instanceof M.control.Printer&&
(b=this.name===a.name);return b};M.control.Printer.TEMPLATE="printer.html";M.control.Printer.LOADING_CLASS="printing";M.control.Printer.DOWNLOAD_ATTR_NAME="data-donwload-url-print";M.control.Printer.NO_TITLE="(Sin t\u00edtulo)"})();P.plugin={};P.plugin.Printer={};
(function(){M.plugin.Printer=function(a){a=a||{};this.panel_=this.control_=this.map_=null;this.url_=M.config.geoprint.URL;M.utils.isNullOrEmpty(a.url)||(this.url_=a.url);this.params_={};M.utils.isNullOrEmpty(a.params)||(this.params_=a.params);this.options_={};M.utils.isNullOrEmpty(a.options)||(this.options_=a.options);M.Plugin.call(this)};goog.inherits(M.plugin.Printer,M.Plugin);M.plugin.Printer.prototype.addTo=function(a){this.map_=a;this.control_=new M.control.Printer(this.url_,this.params_,this.options_);
this.panel_=new M.ui.Panel("printer",{collapsible:!0,className:"m-printer",collapsedButtonClass:"g-cartografia-impresora",position:M.ui.position.TR});this.panel_.on(M.evt.ADDED_TO_MAP,function(a){M.utils.enableTouchScroll(a)});this.panel_.addControls(this.control_);this.map_.addPanels(this.panel_)};M.plugin.Printer.prototype.destroy=function(){this.map_.removeControls([this.control_]);this.options_=this.params_=this.url_=this.panel_=this.control_=this.map_=null}})();P.impl={};P.impl.control={};P.impl.control.Printer={};
...
M.layer.type.WFS?c(b.encodeWFS(a)):a.type===M.layer.type.WMTS?b.encodeWMTS(a).then(function(a){c(a)}):a.type!==M.layer.type.MBtiles&&a.type===M.layer.type.OSM&&c(b.encodeOSM(a)))})};M.impl.control.Printer.prototype.encodeLegend=function(a){var b=null;if(a.displayInLayerSwitcher){var b={name:a.name,classes:[]},c=new RegExp(".*"+M.Layer.LEGEND_DEFAULT+"$"),d=new RegExp(".*"+M.Layer.LEGEND_ERROR+"$"),e=a.getLegendURL();M.utils.isNullOrEmpty(e)||c.test(e)||c.test(d)||(b.classes[0]={name:"",icons:[a.getLegendURL()]})}return b};
M.impl.control.Printer.prototype.encodeKML=function(a){var b=null,c=a.getImpl().getOL3Layer(),b=c.getSource().getFeatures();a=a.name;var c=c.getOpacity(),d=new ol.format.GeoJSON,e=this.facadeMap_.getBbox(),e=[e.x.min,e.y.min,e.x.max,e.y.max],f=this.facadeMap_.getMapImpl().getView().getResolution(),g=[],h={},k={},l=1;b.forEach(function(a){var b=a.getGeometry(),c=a.get("styleUrl");M.utils.isNullOrEmpty(c)||(c=c.replace("#",""));var m=a.getStyle();if(!M.utils.isNullOrEmpty(m)){var q=m.call(a,f)[0];if(!M.utils.isNullOrEmpty(q)){var m=
q.getImage(),t=m.getImageSize();M.utils.isNullOrEmpty(t)&&(t=[64,64]);q=q.getStroke();c={id:c,externalGraphic:m.getSrc(),graphicHeight:t[0],graphicWidth:t[1],graphicOpacity:m.getOpacity(),strokeWidth:q.getWidth()};!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(e)&&(m=JSON.stringify(c),b=k[m],M.utils.isUndefined(b)&&(b=l,k[m]=b,h[b]=c,l++),a=d.writeFeatureObject(a),a.properties={_gx_style:b},g.push(a))}}},this);return b={type:"Vector",styles:h,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",
features:g},name:a,opacity:c}};M.impl.control.Printer.prototype.encodeWMS=function(a){var b=null,c=a.getImpl().getOL3Layer(),b=a.url,d=c.getOpacity(),e=a.getImpl().tiled,c=c.getSource().getParams(),f=c.FORMAT,g=[c.STYLES],b={baseURL:b,opacity:d,singleTile:!e,type:"WMS",layers:(""+c.LAYERS).split(","),format:f||"image/jpeg",styles:g.join(",").split(",")},d=a.getNoChacheName();a=a.getNoChacheUrl();M.utils.isNullOrEmpty(d)||M.utils.isNullOrEmpty(a)||(b.layers=[d],b.baseURL=a);b.customParams={};for(var h in c)-1!==
"iswmc,transparent".indexOf(h.toLowerCase())&&(b.customParams[h]=c[h]);return b};M.impl.control.Printer.prototype.encodeWFS=function(a){var b=null,b=a.getImpl().getOL3Layer(),c=b.getSource().getFeatures();a=a.name;var d=b.getOpacity(),e=b.getStyle(),f=new ol.format.GeoJSON,g=this.facadeMap_.getBbox(),g=[g.x.min,g.y.min,g.x.max,g.y.max],h=this.facadeMap_.getMapImpl().getView().getResolution(),k=[],l={},r={},n=1;c.forEach(function(a){var b=a.getGeometry(),c,d=a.getStyle();M.utils.isNullOrEmpty(d)?M.utils.isNullOrEmpty(e)||
(c=e):c=d.call(a,h)[0];if(!M.utils.isNullOrEmpty(c)){var d=c.getStroke(),u=c.getFill();c=c.getImage();c={fillColor:M.utils.rgbToHex(u.getColor()),fillOpacity:M.utils.getOpacityFromRgba(u.getColor()),strokeColor:M.utils.rgbToHex(d.getColor()),strokeOpacity:M.utils.getOpacityFromRgba(d.getColor()),strokeWidth:d.getWidth(),pointRadius:c.getRadius()};!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(g)&&(d=JSON.stringify(c),b=r[d],M.utils.isUndefined(b)&&(b=n,r[d]=b,l[b]=c,n++),a=f.writeFeatureObject(a),
a.properties={_gx_style:b},k.push(a))}},this);return b={type:"Vector",styles:l,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",features:k},name:a,opacity:d}};M.impl.control.Printer.prototype.encodeWMTS=function(a){var b=this.facadeMap_.getZoom(),c=a.getImpl(),d=c.getOL3Layer(),e=d.getSource(),f=e.getTileGrid(),g=a.url,h=a.name,k=d.getOpacity(),l=e.getRequestEncoding(),r=c.tiled,n=d.getExtent(),p={},m=e.getMatrixSet(),q=f.getTileSize(b),t=f.getResolutions();return a.getImpl().getCapabilities().then(function(a){a=
a.Contents.TileMatrixSet.filter(function(a){return a.Identifier===m})[0];return{baseURL:g,opacity:k,singleTile:!r,type:"WMTS",layer:h,requestEncoding:l,tileSize:q,style:"deafult",rotation:0,imageFormat:"image/png",dimensionParams:{},dimensions:[],params:p,version:"1.0.0",maxExtent:n,matrixSet:m,matrixIds:a.TileMatrix.map(function(a,b){return{identifier:a.Identifier,matrixSize:[a.MatrixHeight,a.MatrixWidth],scaleDenominator:a.ScaleDenominator,tileSize:[a.TileWidth,a.TileHeight],topLeftCorner:a.TopLeftCorner}}),
resolutions:t}})};M.impl.control.Printer.prototype.encodeOSM=function(a){var b=null,c=a.getImpl(),d=c.getOL3Layer(),e=d.getSource().getTileGrid(),b=a.url;a=a.name;var f=d.getOpacity(),c=c.tiled,d=d.getExtent(),g=e.getTileSize(),e=e.getResolutions();return b={baseURL:b.substr(0,b.indexOf("$")),opacity:f,singleTile:!c,layer:a,maxExtent:d,tileSize:g,resolutions:e,type:"OSM",extension:"png"}};M.impl.control.Printer.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_=
...
goog.exportProperty(M.impl.control.Printer.prototype,"destroy",M.impl.control.Printer.prototype.destroy);goog.exportSymbol("M.plugin.Printer",M.plugin.Printer);goog.exportProperty(M.plugin.Printer.prototype,"addTo",M.plugin.Printer.prototype.addTo);goog.exportProperty(M.plugin.Printer.prototype,"destroy",M.plugin.Printer.prototype.destroy);goog.exportSymbol("M.control.Printer",M.control.Printer);goog.exportProperty(M.control.Printer.prototype,"createView",M.control.Printer.prototype.createView);
goog.exportProperty(M.control.Printer.prototype,"addEvents",M.control.Printer.prototype.addEvents);goog.exportProperty(M.control.Printer.prototype,"getCapabilities",M.control.Printer.prototype.getCapabilities);goog.exportProperty(M.control.Printer.prototype,"createQueueElement",M.control.Printer.prototype.createQueueElement);goog.exportProperty(M.control.Printer.prototype,"dowloadPrint",M.control.Printer.prototype.dowloadPrint);goog.exportProperty(M.control.Printer.prototype,"equals",M.control.Printer.prototype.equals);
goog.exportSymbol("M.control.Printer.TEMPLATE",M.control.Printer.TEMPLATE);goog.exportSymbol("M.control.Printer.LOADING_CLASS",M.control.Printer.LOADING_CLASS);goog.exportSymbol("M.control.Printer.DOWNLOAD_ATTR_NAME",M.control.Printer.DOWNLOAD_ATTR_NAME);goog.exportSymbol("M.control.Printer.NO_TITLE",M.control.Printer.NO_TITLE); })(window.M);
