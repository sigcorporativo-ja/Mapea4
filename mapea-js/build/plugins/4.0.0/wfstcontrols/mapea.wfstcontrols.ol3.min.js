...
function(a){return a instanceof M.control.SaveFeature};M.control.SaveFeature.prototype.manageActivation=function(a){a=a.querySelector("button#m-button-savefeature");goog.events.listen(a,goog.events.EventType.CLICK,this.saveFeature_,!1,this)};M.control.SaveFeature.prototype.saveFeature_=function(a){this.getImpl().saveFeature()};M.control.SaveFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.SaveFeature.NAME="savefeature";M.control.SaveFeature.TEMPLATE="savefeature.html"})();P.plugin={};P.plugin.WFSTControls={};M.plugin.WFSTControls=function(a,b){this.controls=a;this.layername_=b;this.editattibute_=this.savefeature_=this.clearfeature_=this.deletefeature_=this.modifyfeature_=this.drawfeature_=this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.WFSTControls,M.Plugin);
...
M.utils.isNullOrEmpty(a)||(a.getImpl().modifiedFeatures.length=0,a.deactivate());a=this.facadeMap_.getControls("deletefeature")[0];M.utils.isNullOrEmpty(a)||(a.getImpl().modifiedFeatures.length=0,a.deactivate());a=this.facadeMap_.getControls("editattribute")[0];M.utils.isNullOrEmpty(a)||(a.getImpl().editedFeature=null,a.deactivate());this.layer_.getImpl().refresh()};M.impl.control.ClearFeature.prototype.destroy=function(){this.layer_=null;this.facadeMap_.getMapImpl().removeControl(this)}})();P.impl.control.WFSTBase={};
(function(){M.impl.control.WFSTBase=function(a){this.layer_=a;this.describeFeatureType_=this.interaction_=null;this.modifiedFeatures=[];M.impl.Control.call(this)};goog.inherits(M.impl.control.WFSTBase,M.impl.Control);M.impl.control.WFSTBase.prototype.addTo=function(a,b){this.facadeMap_=a;ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.WFSTBase.prototype.activate=function(){if(M.utils.isNullOrEmpty(this.interaction_)){var a=this;this.layer_.getImpl().getDescribeFeatureType().then(function(b){a.describeFeatureType_=
b;a.createInteraction_();a.facadeMap_.getMapImpl().addInteraction(a.interaction_);a.interaction_.setActive(!0)})}else this.interaction_.setActive(!0)};M.impl.control.WFSTBase.prototype.deactivate=function(){if(M.utils.isNullOrEmpty(this.interaction_)){var a=this;this.layer_.getImpl().getDescribeFeatureType().then(function(b){a.describeFeatureType_=b;a.createInteraction_();a.facadeMap_.getMapImpl().addInteraction(a.interaction_);a.interaction_.setActive(!1)})}else this.interaction_.setActive(!1)};
M.impl.control.WFSTBase.prototype.createInteraction_=function(){};M.impl.control.WFSTBase.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.modifiedFeatures=this.describeFeatureType_=this.interaction_=this.layer_=null}})();P.impl.control.DeleteFeature={};
...
b){var c=a[0];this.layer_.getImpl().getOL3Layer().getSource().removeFeature(c);if(M.utils.isNullOrEmpty(c.getId())){var d=this.facadeMap_.getControls("drawfeature")[0];M.utils.isNullOrEmpty(d)||(d=d.getImpl().modifiedFeatures,c=d.indexOf(c),d.splice(c,1))}else this.modifiedFeatures.push(c)}})();P.impl.control.DrawFeature={};
(function(){M.impl.control.DrawFeature=function(a){M.impl.control.WFSTBase.call(this,a)};goog.inherits(M.impl.control.DrawFeature,M.impl.control.WFSTBase);M.impl.control.DrawFeature.prototype.createInteraction_=function(){var a=this.layer_.getImpl(),b=a.getOL3Layer();this.interaction_=new ol.interaction.Draw({source:b.getSource(),type:M.geom.parseWFS(this.layer_.geometry),style:b.getStyle(),geometryName:this.describeFeatureType_.geometryName});this.interaction_.on("drawend",function(b){var d=b.feature;
this.describeFeatureType_.properties.forEach(function(b){M.utils.isGeometryType(b.localType)||d.set(b.name,a.getDefaultValue(b.localType))});this.modifiedFeatures.push(d)},this);a.on(M.evt.LOAD,this.updateLayerFeatures_,this)};M.impl.control.DrawFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.interaction_);this.interaction_=null}})();P.impl.control.EditAttribute={};
(function(){M.impl.control.EditAttribute=function(a){this.layer_=a;this.editFeature=this.describeFeatureType_=null;M.impl.Control.call(this)};goog.inherits(M.impl.control.EditAttribute,M.impl.Control);M.impl.control.EditAttribute.prototype.activate=function(){var a=this.layer_.getImpl(),b=this;a.getDescribeFeatureType().then(function(c){b.describeFeatureType_=c;a.on(M.evt.SELECT_FEATURES,b.showEditPopup_,b);a.on(M.evt.UNSELECT_FEATURES,b.unselectFeature_,b)})};M.impl.control.EditAttribute.prototype.deactivate=function(){var a=
this.layer_.getImpl();a.un(M.evt.SELECT_FEATURES,this.showEditPopup_,this);a.un(M.evt.UNSELECT_FEATURES,this.unselectFeature_,this)};M.impl.control.EditAttribute.prototype.showEditPopup_=function(a,b){this.editFeature=a[0];if(M.utils.isNullOrEmpty(this.editFeature.getId()))this.editFeature=null,M.dialog.info("Debe guardar el elemento previamente");else{this.editFeature.setStyle(M.impl.control.EditAttribute.SELECTED_STYLE);var c={properties:[]};this.describeFeatureType_.properties.forEach(function(a){M.utils.isGeometryType(a.localType)||
c.properties.push({key:a.name,value:this.editFeature.get(a.name),type:a.localType})},this);var d=this;M.template.compile(M.control.EditAttribute.TEMPLATE_POPUP,{jsonp:!0,vars:c,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-texto",title:M.control.EditAttribute.POPUP_TITLE,content:a};d.popup_=d.facadeMap_.getPopup();M.utils.isNullOrEmpty(d.popup_)?(d.popup_=new M.Popup,d.popup_.addTab(a),d.facadeMap_.addPopup(d.popup_,b)):d.popup_.getTabs().some(function(a){return a.title!==M.control.EditAttribute.POPUP_TITLE})?
d.popup_.addTab(a):(d.facadeMap_.removePopup(),d.popup_=new M.Popup,d.popup_.addTab(a),d.facadeMap_.addPopup(d.popup_,b));d.popup_.on(M.evt.SHOW,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.listen(a,goog.events.EventType.CLICK,this.saveAttributes_,!1,this)},d);d.popup_.on(M.evt.DESTROY,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.unlisten(a,
goog.events.EventType.CLICK,this.saveAttributes_,!1,this);this.unselectFeature_()},d)})}};M.impl.control.EditAttribute.prototype.saveAttributes_=function(a){this.editFeature.unset("bbox",!0);var b=this.popup_.getContent(),c=a.target;a=this.editFeature.getProperties();goog.dom.classes.add(c,"m-savefeature-saving");Object.keys(a).forEach(function(a){if(null!==b.querySelector("input#"+a)){var c=b.querySelector("input#"+a).value;this.editFeature.set(a,c,!0)}},this);a=this.facadeMap_.getProjection().code;
a=(new ol.format.WFS).writeTransaction(null,[this.editFeature],null,{featureNS:this.describeFeatureType_.featureNS,featurePrefix:this.describeFeatureType_.featurePrefix,featureType:this.layer_.name,srsName:a,gmlOptions:{srsName:a}});a=goog.dom.xml.serialize(a);this.facadeMap_.removePopup(this.popup_);M.remote.post(this.layer_.url,a).then(function(a){goog.dom.classes.remove(c,"m-savefeature-saving");200===a.code?M.dialog.success("Se ha guardado correctamente el elemento"):M.dialog.error("Ha ocurrido un error al guardar: ".concat(a.text))})};
M.impl.control.EditAttribute.prototype.unselectFeature_=function(){null!==this.editFeature&&(this.editFeature.setStyle(M.impl.layer.WFS.STYLE),this.editFeature=null,this.facadeMap_.removePopup())};M.impl.control.EditAttribute.prototype.destroy=function(){M.impl.control.EditAttribute.superClass_.destroy.call(this);this.facadeMap_.removePopup()};M.impl.control.EditAttribute.SELECTED_STYLE=new ol.style.Style({fill:new ol.style.Fill({color:"rgba(175, 127, 19, 0.2)"}),stroke:new ol.style.Stroke({color:"#af7f13",
width:2}),image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#af7f13"})})})})();P.impl.control.ModifyFeature={};
...
};goog.dom.xml.loadXml=function(a,b){if(!("undefined"==typeof DOMParser||goog.dom.xml.ACTIVEX_SUPPORT&&b))return(new DOMParser).parseFromString(a,"application/xml");if(goog.dom.xml.ACTIVEX_SUPPORT){var c=goog.dom.xml.createMsXmlDocument_();c.loadXML(a);return c}throw Error("Your browser does not support loading xml documents");};
...
(function(){M.impl.control.SaveFeature=function(a){this.layer_=a};goog.inherits(M.impl.control.SaveFeature,M.impl.Control);M.impl.control.SaveFeature.prototype.addTo=function(a,b){this.facadeMap_=a;M.impl.control.SaveFeature.superClass_.addTo.call(this,a,b)};M.impl.control.SaveFeature.prototype.saveFeature=function(){var a=null,b=null,c=null,d=this.facadeMap_.getControls(M.control.DrawFeature.NAME)[0];M.utils.isNullOrEmpty(d)||(a=d.getImpl().modifiedFeatures);d=this.facadeMap_.getControls(M.control.ModifyFeature.NAME)[0];M.utils.isNullOrEmpty(d)||
(b=d.getImpl().modifiedFeatures);d=this.facadeMap_.getControls(M.control.DeleteFeature.NAME)[0];M.utils.isNullOrEmpty(d)||(c=d.getImpl().modifiedFeatures);b.forEach(function(a){a.unset("bbox")});a.forEach(function(a){a.unset("bbox")});var e=this;this.layer_.getImpl().getDescribeFeatureType().then(function(d){var g=e.facadeMap_.getProjection().code;d=(new ol.format.WFS).writeTransaction(a,b,c,{featureNS:d.featureNS,featurePrefix:d.featurePrefix,featureType:e.layer_.name,srsName:g,gmlOptions:{srsName:g}});
d=goog.dom.xml.serialize(d);M.remote.post(e.layer_.url,d).then(function(a){e.facadeMap_.getControls(M.control.ClearFeature.NAME)[0].getImpl().clear();200===a.code&&-1===a.text.indexOf("ExceptionText")?M.dialog.success("Se ha guardado correctamente"):M.dialog.error("Ha ocurrido un error al guardar: ".concat(a.text))})})};M.impl.control.SaveFeature.prototype.destroy=function(){this.layer_=null;this.facadeMap_.getMapImpl().removeControl(this)}})();goog.exportSymbol("M.control.ClearFeature",M.control.ClearFeature);goog.exportProperty(M.control.ClearFeature.prototype,"createView",M.control.ClearFeature.prototype.createView);goog.exportProperty(M.control.ClearFeature.prototype,"manageActivation",M.control.ClearFeature.prototype.manageActivation);goog.exportProperty(M.control.ClearFeature.prototype,"equals",M.control.ClearFeature.prototype.equals);goog.exportProperty(M.control.ClearFeature.prototype,"setLayer",M.control.ClearFeature.prototype.setLayer);
...
goog.exportSymbol("M.control.ModifyFeature.NAME",M.control.ModifyFeature.NAME);goog.exportSymbol("M.control.ModifyFeature.TEMPLATE",M.control.ModifyFeature.TEMPLATE);goog.exportSymbol("M.impl.control.ModifyFeature",M.impl.control.ModifyFeature);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"activate",M.impl.control.ModifyFeature.prototype.activate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"deactivate",M.impl.control.ModifyFeature.prototype.deactivate);
goog.exportProperty(M.impl.control.ModifyFeature.prototype,"destroy",M.impl.control.ModifyFeature.prototype.destroy);goog.exportSymbol("M.control.SaveFeature",M.control.SaveFeature);goog.exportProperty(M.control.SaveFeature.prototype,"createView",M.control.SaveFeature.prototype.createView);goog.exportProperty(M.control.SaveFeature.prototype,"equals",M.control.SaveFeature.prototype.equals);goog.exportProperty(M.control.SaveFeature.prototype,"manageActivation",M.control.SaveFeature.prototype.manageActivation);
goog.exportProperty(M.control.SaveFeature.prototype,"saveFeature_",M.control.SaveFeature.prototype.saveFeature_);goog.exportProperty(M.control.SaveFeature.prototype,"setLayer",M.control.SaveFeature.prototype.setLayer);goog.exportSymbol("M.control.SaveFeature.NAME",M.control.SaveFeature.NAME);goog.exportSymbol("M.control.SaveFeature.TEMPLATE",M.control.SaveFeature.TEMPLATE);goog.exportSymbol("M.impl.control.SaveFeature",M.impl.control.SaveFeature);
goog.exportProperty(M.impl.control.SaveFeature.prototype,"addTo",M.impl.control.SaveFeature.prototype.addTo);goog.exportProperty(M.impl.control.SaveFeature.prototype,"saveFeature",M.impl.control.SaveFeature.prototype.saveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"destroy",M.impl.control.SaveFeature.prototype.destroy);goog.exportSymbol("M.plugin.WFSTControls",M.plugin.WFSTControls);goog.exportProperty(M.plugin.WFSTControls.prototype,"addTo",M.plugin.WFSTControls.prototype.addTo);
goog.exportProperty(M.plugin.WFSTControls.prototype,"destroy",M.plugin.WFSTControls.prototype.destroy);goog.exportProperty(M.plugin.WFSTControls.prototype,"setLayer",M.plugin.WFSTControls.prototype.setLayer);goog.exportSymbol("M.impl.control.WFSTBase",M.impl.control.WFSTBase);goog.exportProperty(M.impl.control.WFSTBase.prototype,"modifiedFeatures",M.impl.control.WFSTBase.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.WFSTBase.prototype,"addTo",M.impl.control.WFSTBase.prototype.addTo);
goog.exportProperty(M.impl.control.WFSTBase.prototype,"activate",M.impl.control.WFSTBase.prototype.activate);goog.exportProperty(M.impl.control.WFSTBase.prototype,"deactivate",M.impl.control.WFSTBase.prototype.deactivate);goog.exportProperty(M.impl.control.WFSTBase.prototype,"destroy",M.impl.control.WFSTBase.prototype.destroy); })(window.M);
