...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var b=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var e=b.length,f=a.length;c=Math.max(0,Math.min(c|0,b.length));for(var g=0;g<f&&c<e;)if(b[c++]!=a[g++])return!1;return g>=f}},"es6-impl","es3");$jscomp.EXPOSE_ASYNC_EXECUTOR=!0;$jscomp.FORCE_POLYFILL_PROMISE=!1;
...
return d},"es6-impl","es3");$jscomp.array=$jscomp.array||{};$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,d={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}d.next=function(){return{done:!0,value:void 0}};return d.next()}};d[Symbol.iterator]=function(){return d};return d};
$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6-impl","es3");$jscomp.polyfill("Array.prototype.values",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return c})}},"es6","es3");var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var P={control:{}};P.control.AttributeTableControl={};
M.control.AttributeTableControl=function(a){a=$jscomp.makeIterator([null,!1,null,null,null,a,null]);this.facadeMap_=a.next().value;this.selectAllActive_=a.next().value;this.template_=a.next().value;this.areaTable_=a.next().value;this.layer_=a.next().value;this.numPages_=a.next().value;this.draggable_=a.next().value;this.pages_={total:0,actual:1,element:0};this.sortProperties_={active:!1,sortBy:null,sortType:null};M.utils.isUndefined(M.impl.control.AttributeTableControl)&&M.exception("La implementaci\u00f3n usada no puede crear controles AttributeTableControl");
a=new M.impl.control.AttributeTableControl;M.Control.call(this,a,"AttributeTable")};goog.inherits(M.control.AttributeTableControl,M.Control);
M.control.AttributeTableControl.prototype.createView=function(a){this.facadeMap_=a;return new Promise(function(b,c){M.template.compile("attributetable.html",{jsonp:!0,vars:{layers:a.getWFS().concat(a.getKML().concat(a.getLayers().filter(function(a){return"GeoJSON"===a.type})))}}).then(function(a){var c=this.getPanel().getTemplatePanel();goog.events.listen(c.querySelector(".g-cartografia-localizacion4"),goog.events.EventType.CLICK,function(){this.getPanel().isCollapsed()&&(c.style.removeProperty("left"),
c.style.removeProperty("top"))},!1,this);goog.events.listen(this.getPanel().getTemplatePanel().querySelector(".g-cartografia-localizacion4"),goog.events.EventType.CLICK,function(){M.window.WIDTH>=M.config.MOBILE_WIDTH&&(this.getPanel().isCollapsed()?this.deactivateDraggable_():this.activateDraggable_())},!1,this);this.template_=a;this.areaTable_=a.querySelector("div#m-attributetable-datas");goog.events.listen(a.querySelector("#m-attributetable-layer"),goog.events.EventType.CLICK,this.openPanel_,!1,
this);goog.events.listen(a.querySelector("#m-attributetable-select"),goog.events.EventType.CHANGE,function(a){this.pages_={total:0,actual:1,element:0};this.sortProperties_={active:!1,sortBy:null,sortType:null};this.renderPanel_(a.target[a.target.selectedIndex].getAttribute("name"))},!1,this);b(a)}.bind(this))}.bind(this))};M.control.AttributeTableControl.prototype.refresh_=function(){this.renderPanel_()};
M.control.AttributeTableControl.prototype.renderPanel_=function(a){M.utils.isNullOrEmpty(a)||(this.layer_=this.hasLayer_(a)[0]);a=this.layer_.getFeatures();if(!M.utils.isNullOrEmpty(a)){var b=Object.keys(a[0].getAttributes()),c=b.indexOf("geometry");b.splice(c,1);var d=[];a.forEach(function(a){a=Object.values(a.getAttributes());-1!==c&&a.splice(c,1);M.utils.isNullOrEmpty(a)||d.push(a)});this.sortProperties_.active&&(d=this.sortAttributes_(d,b))}return new Promise(function(a,c){c={};M.utils.isUndefined(b)||
(c={headerAtt:b,legend:this.layer_.legend,pages:this.pageResults_(d),attributes:M.utils.isNullOrEmpty(d)?!1:d.slice(this.pages_.element,this.pages_.element+this.numPages_)});M.template.compile("tableData.html",{jsonp:!0,vars:c}).then(function(b){var c=this.areaTable_.querySelector("table");M.utils.isNullOrEmpty(c)||this.areaTable_.removeChild(this.areaTable_.querySelector("#m-attributetable-content-attributes"));c=this.areaTable_.querySelector(".m-attributetable-notResult");M.utils.isNullOrEmpty(c)||
this.areaTable_.removeChild(this.areaTable_.querySelector("#m-attributetable-content-attributes"));this.areaTable_.appendChild(b);M.utils.isNullOrEmpty(b.querySelector("div.m-attributetable-notResult"))?(goog.events.listen(this.areaTable_.querySelector("#m-attributetable-next"),goog.events.EventType.CLICK,this.nextPage_,!1,this),goog.events.listen(b.querySelector("#m-attributetable-previous"),goog.events.EventType.CLICK,this.previousPage_,!1,this),goog.events.listen(b.querySelector("input[value=selectAll]"),
goog.events.EventType.CLICK,this.selectAll,!1,this),goog.events.listen(b.querySelector("#m-attributetable-attributes"),goog.events.EventType.CLICK,this.openPanel_,!1,this),goog.events.listen(b.querySelector("#m-attributetable-refresh"),goog.events.EventType.CLICK,this.refresh_,!1,this),Array.prototype.slice.call(this.areaTable_.querySelector("tr").querySelectorAll("td"),1).forEach(function(a){goog.events.listen(a,goog.events.EventType.CLICK,this.sort_,!1,this)}.bind(this)),this.hasNext_(b),this.hasPrevious_(b)):
goog.events.listen(b.querySelector("#m-attributetable-refresh"),goog.events.EventType.CLICK,this.refresh_,!1,this);this.rePosition_();a()}.bind(this))}.bind(this))};
M.control.AttributeTableControl.prototype.hasLayer_=function(a){var b=[];if(M.utils.isNullOrEmpty(a)||!(M.utils.isArray(a)||M.utils.isString(a)||a instanceof M.Layer))return M.dialog.error("El parametro para el m\u00e9todo hasLayer no es correcto.","Error"),b;M.utils.isString(a)&&this.facadeMap_.getLayers().forEach(function(c){c.name==a&&b.push(c)});a instanceof M.Layer&&this.facadeMap_.getLayers().forEach(function(c){c.equals(a)&&b.push(c)});M.utils.isArray(a)&&this.facadeMap_.getLayers().forEach(function(c){0<=
a.indexOf(c.name)&&b.push(c)});return b};M.control.AttributeTableControl.prototype.selectAll=function(){this.selectAllActive_=this.selectAllActive_?!1:!0;!0===this.selectAllActive_?this.addSelectAll_():this.removeSelectAll_()};M.control.AttributeTableControl.prototype.addSelectAll_=function(){this.areaTable_.querySelectorAll("input").forEach(function(a){a.setAttribute("checked",!0)})};M.control.AttributeTableControl.prototype.removeSelectAll_=function(){this.areaTable_.querySelectorAll("input").forEach(function(a){a.removeAttribute("checked")})};
M.control.AttributeTableControl.prototype.pageResults_=function(a){this.pages_.total=Math.ceil(a.length/this.numPages_);return this.pages_};M.control.AttributeTableControl.prototype.nextPage_=function(){this.pages_.total>this.pages_.actual&&(this.pages_.actual+=1,this.pages_.element+=this.numPages_,this.renderPanel_().then(function(){this.hasNext_();this.hasPrevious_()}.bind(this)))};
M.control.AttributeTableControl.prototype.previousPage_=function(){this.pages_.total>=this.pages_.actual&&(--this.pages_.actual,this.pages_.element-=this.numPages_,this.renderPanel_().then(function(){this.hasPrevious_()}.bind(this)))};M.control.AttributeTableControl.prototype.hasNext_=function(a){var b=this.template_;M.utils.isNullOrEmpty(a)||(b=a);this.pages_.actual<this.pages_.total&&goog.dom.classlist.remove(b.querySelector("#m-attributetable-next"),"m-attributetable-hidden")};
M.control.AttributeTableControl.prototype.hasPrevious_=function(a){var b=this.template_;M.utils.isNullOrEmpty(a)||(b=a);this.pages_.actual<=this.pages_.total&&1!==this.pages_.actual&&goog.dom.classlist.remove(b.querySelector("#m-attributetable-previous"),"m-attributetable-hidden")};
M.control.AttributeTableControl.prototype.sort_=function(a){!1===this.sortProperties_.active&&(this.sortProperties_.active=!0);this.sortProperties_.sortType=this.sortProperties_.sortBy!==a.target.innerHTML?"<":">"===this.sortProperties_.sortType?"<":">";this.sortProperties_.sortBy=a.target.innerHTML;this.renderPanel_()};
M.control.AttributeTableControl.prototype.sortAttributes_=function(a,b){var c=b.indexOf(this.sortProperties_.sortBy);a=a.sort(function(a,b){return a[c]-b[c]});">"===this.sortProperties_.sortType&&(a=a.reverse());return a};
M.control.AttributeTableControl.prototype.openPanel_=function(a){a=a.target.id;"m-attributetable-layer"===a?(a=this.template_.querySelector("select#m-attributetable-select"),goog.dom.classlist.toggle(a,"m-attributetable-hidden"),goog.dom.classlist.toggle(a,"show")):"m-attributetable-attributes"===a&&(goog.dom.classlist.toggle(this.template_.querySelector("#m-attributetable-table"),"m-attributetable-hidden"),goog.dom.classlist.toggle(this.template_.querySelector("#m-attributetable-tfoot"),"m-attributetable-hidden"));
this.rePosition_()};M.control.AttributeTableControl.prototype.activateDraggable_=function(){if(M.utils.isNullOrEmpty(this.draggable_)){this.setFixed_();var a=this.getPanel().getTemplatePanel();this.draggable_=new Draggabilly(a,{containment:".m-mapea-container",handle:".m-attributetable-container>div.m-attributetable-panel div.title"})}this.draggable_.enable()};
M.control.AttributeTableControl.prototype.deactivateDraggable_=function(){document.querySelector(".m-attributetable").style.position="relative";this.draggable_.disable()};M.control.AttributeTableControl.prototype.setFixed_=function(){var a=document.querySelector(".m-attributetable"),b=a.getBoundingClientRect();a.style.position="fixed";a.style.left=b.left+"px";a.style.top=b.top+"px"};
M.control.AttributeTableControl.prototype.rePosition_=function(){var a=this.getPanel().getTemplatePanel();parseInt(a.style.left.replace("px",""))+a.clientWidth>document.querySelector(".m-mapea-container").clientWidth&&(a.style.left=document.querySelector(".m-mapea-container").clientWidth-a.clientWidth+"px");parseInt(a.style.top.replace("px",""))+a.clientHeight>document.querySelector(".m-mapea-container").clientHeight&&(a.style.top=document.querySelector(".m-mapea-container").clientHeight-a.clientHeight-
10+"px")};goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});P.plugin={};P.plugin.AttributeTable={};M.plugin.AttributeTable=function(a){var b=$jscomp.makeIterator([null,null,null]);this.control_=b.next().value;this.panel_=b.next().value;this.facadeMap_=b.next().value;a=a||{};this.numPages_=parseInt(!M.utils.isNullOrEmpty(a.pages)&&1<=a.pages&&0===a.pages%1?a.pages:M.config.ATTRIBUTETABLE_PAGES);this.name=M.plugin.AttributeTable.NAME;M.Plugin.call(this)};goog.inherits(M.plugin.AttributeTable,M.Plugin);
M.plugin.AttributeTable.prototype.addTo=function(a){this.facadeMap_=a;this.control_=new M.control.AttributeTableControl(this.numPages_);this.panel_=new M.ui.Panel("M.plugin.AttributeTable.NAME",{collapsible:!0,className:"m-attributetable",collapsedButtonClass:"g-cartografia-localizacion4",position:M.ui.position.TR,tooltip:"Tabla de atributos"});this.panel_.addControls(this.control_);this.panel_.on(M.evt.SHOW,function(b){0===a.getWFS().length&&0===a.getKML().length&&0===a.getLayers().filter(function(a){return"GeoJSON"===
a.type})&&(this.panel_.collapse(),M.dialog.info("No existen capas consultables."))},this);a.addPanels(this.panel_)};M.plugin.AttributeTable.prototype.destroy=function(){this.map_.removeControls([this.control_]);var a=$jscomp.makeIterator([null,null,null]);this.control_=a.next().value;this.panel_=a.next().value;this.facadeMap_=a.next().value};M.plugin.AttributeTable.NAME="attributetable";P.impl={};P.impl.control={};P.impl.control.AttributeTableControl={};M.impl.control.AttributeTableControl=function(){M.impl.Control.call(this)};goog.inherits(M.impl.control.AttributeTableControl,M.impl.Control);M.impl.control.AttributeTableControl.prototype.addTo=function(a,b){M.impl.control.AttributeTableControl.superClass_.addTo.call(this,a,b)};M.impl.control.AttributeTableControl.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this)};M.impl.control.AttributeTableControl.PANEL_ID="m-attibutetable-panel";goog.exportSymbol("M.plugin.AttributeTable",M.plugin.AttributeTable);goog.exportProperty(M.plugin.AttributeTable.prototype,"name",M.plugin.AttributeTable.prototype.name);goog.exportProperty(M.plugin.AttributeTable.prototype,"addTo",M.plugin.AttributeTable.prototype.addTo);goog.exportProperty(M.plugin.AttributeTable.prototype,"destroy",M.plugin.AttributeTable.prototype.destroy);goog.exportSymbol("M.plugin.AttributeTable.NAME",M.plugin.AttributeTable.NAME);
goog.exportSymbol("M.impl.control.AttributeTableControl",M.impl.control.AttributeTableControl);goog.exportProperty(M.impl.control.AttributeTableControl.prototype,"addTo",M.impl.control.AttributeTableControl.prototype.addTo);goog.exportSymbol("M.impl.control.AttributeTableControl.destroy",M.impl.control.AttributeTableControl.destroy);goog.exportSymbol("M.impl.control.AttributeTableControl.PANEL_ID",M.impl.control.AttributeTableControl.PANEL_ID);goog.exportSymbol("M.control.AttributeTableControl",M.control.AttributeTableControl);
goog.exportProperty(M.control.AttributeTableControl.prototype,"createView",M.control.AttributeTableControl.prototype.createView);goog.exportProperty(M.control.AttributeTableControl.prototype,"openPanel_",M.control.AttributeTableControl.prototype.openPanel_);goog.exportProperty(M.control.AttributeTableControl.prototype,"activateDraggable_",M.control.AttributeTableControl.prototype.activateDraggable_);goog.exportProperty(M.control.AttributeTableControl.prototype,"deactivateDraggable_",M.control.AttributeTableControl.prototype.deactivateDraggable_);
goog.exportProperty(M.control.AttributeTableControl.prototype,"setFixed_",M.control.AttributeTableControl.prototype.setFixed_);goog.exportProperty(M.control.AttributeTableControl.prototype,"rePosition_",M.control.AttributeTableControl.prototype.rePosition_); })(window.M);
