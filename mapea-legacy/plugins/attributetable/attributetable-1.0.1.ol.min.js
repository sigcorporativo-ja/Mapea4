...
M.control.AttributeTableControl.prototype.renderPanel_=function(a){M.utils.isNullOrEmpty(a)||(this.layer_=this.hasLayer_(a)[0]);a=this.layer_.getFeatures();if(!M.utils.isNullOrEmpty(a)){var b=Object.keys(a[0].getAttributes()),c=[];a.forEach(function(a){a=Object.values(a.getAttributes());M.utils.isNullOrEmpty(a)||c.push(a)});this.sortProperties_.active&&(c=this.sortAttributes_(c,b))}return new Promise(function(a,e){e={};M.utils.isUndefined(b)||(e={headerAtt:b,legend:this.layer_.legend,pages:this.pageResults_(c),
attributes:M.utils.isNullOrEmpty(c)?!1:c.slice(this.pages_.element,this.pages_.element+this.numPages_)});M.template.compile("tableData.html",{jsonp:!0,vars:e}).then(function(b){var c=this.areaTable_.querySelector("table");M.utils.isNullOrEmpty(c)||this.areaTable_.removeChild(this.areaTable_.querySelector("#m-attributetable-content-attributes"));c=this.areaTable_.querySelector(".m-attributetable-notResult");M.utils.isNullOrEmpty(c)||this.areaTable_.removeChild(this.areaTable_.querySelector("#m-attributetable-content-attributes"));
this.areaTable_.appendChild(b);M.utils.isNullOrEmpty(b.querySelector("div.m-attributetable-notResult"))?(goog.events.listen(this.areaTable_.querySelector("#m-attributetable-next"),goog.events.EventType.CLICK,this.nextPage_,!1,this),goog.events.listen(b.querySelector("#m-attributetable-previous"),goog.events.EventType.CLICK,this.previousPage_,!1,this),goog.events.listen(b.querySelector("input[value=selectAll]"),goog.events.EventType.CLICK,this.selectAll,!1,this),goog.events.listen(b.querySelector("#m-attributetable-attributes"),
goog.events.EventType.CLICK,this.openPanel_,!1,this),goog.events.listen(b.querySelector("#m-attributetable-refresh"),goog.events.EventType.CLICK,this.refresh_,!1,this),Array.prototype.slice.call(this.areaTable_.querySelector("tr").querySelectorAll("td"),1).forEach(function(a){goog.events.listen(a,goog.events.EventType.CLICK,this.sort_,!1,this)}.bind(this)),this.hasNext_(b),this.hasPrevious_(b)):goog.events.listen(b.querySelector("#m-attributetable-refresh"),goog.events.EventType.CLICK,this.refresh_,
!1,this);this.rePosition_();a()}.bind(this))}.bind(this))};
...
M.plugin.AttributeTable.prototype.addTo=function(a){var b=this;a.on(M.evt.ADDED_LAYER,function(){b.destroy();c.bind(b)()},this);var c=function(){b.facadeMap_=a;b.control_=new M.control.AttributeTableControl(b.numPages_);b.panel_=new M.ui.Panel(M.plugin.AttributeTable.NAME,{collapsible:!0,className:"m-attributetable",collapsedButtonClass:"g-cartografia-localizacion4",position:M.ui.position.TR,tooltip:"Tabla de atributos"});b.panel_.addControls(b.control_);b.panel_.on(M.evt.SHOW,function(b){0===a.getWFS().length&&
0===a.getKML().length&&0===a.getLayers().filter(function(a){return"GeoJSON"===a.type})&&(this.panel_.collapse(),M.dialog.info("No existen capas consultables."))},b);a.addPanels(b.panel_)};c()};M.plugin.AttributeTable.prototype.destroy=function(){this.facadeMap_.removeControls([this.control_]);var a=$jscomp.makeIterator([null,null,null]);this.control_=a.next().value;this.panel_=a.next().value;this.facadeMap_=a.next().value};M.plugin.AttributeTable.NAME="attributetable";P.impl={};P.impl.control={};P.impl.control.AttributeTableControl={};M.impl.control.AttributeTableControl=function(){M.impl.Control.call(this)};goog.inherits(M.impl.control.AttributeTableControl,M.impl.Control);M.impl.control.AttributeTableControl.prototype.addTo=function(a,b){M.impl.control.AttributeTableControl.superClass_.addTo.call(this,a,b)};M.impl.control.AttributeTableControl.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this)};M.impl.control.AttributeTableControl.PANEL_ID="m-attibutetable-panel";goog.exportSymbol("M.plugin.AttributeTable",M.plugin.AttributeTable);goog.exportProperty(M.plugin.AttributeTable.prototype,"name",M.plugin.AttributeTable.prototype.name);goog.exportProperty(M.plugin.AttributeTable.prototype,"addTo",M.plugin.AttributeTable.prototype.addTo);goog.exportProperty(M.plugin.AttributeTable.prototype,"destroy",M.plugin.AttributeTable.prototype.destroy);goog.exportSymbol("M.plugin.AttributeTable.NAME",M.plugin.AttributeTable.NAME);
goog.exportSymbol("M.control.AttributeTableControl",M.control.AttributeTableControl);goog.exportProperty(M.control.AttributeTableControl.prototype,"createView",M.control.AttributeTableControl.prototype.createView);goog.exportProperty(M.control.AttributeTableControl.prototype,"openPanel_",M.control.AttributeTableControl.prototype.openPanel_);goog.exportProperty(M.control.AttributeTableControl.prototype,"activateDraggable_",M.control.AttributeTableControl.prototype.activateDraggable_);
goog.exportProperty(M.control.AttributeTableControl.prototype,"deactivateDraggable_",M.control.AttributeTableControl.prototype.deactivateDraggable_);goog.exportProperty(M.control.AttributeTableControl.prototype,"setFixed_",M.control.AttributeTableControl.prototype.setFixed_);goog.exportProperty(M.control.AttributeTableControl.prototype,"rePosition_",M.control.AttributeTableControl.prototype.rePosition_);goog.exportSymbol("M.impl.control.AttributeTableControl",M.impl.control.AttributeTableControl);
goog.exportProperty(M.impl.control.AttributeTableControl.prototype,"addTo",M.impl.control.AttributeTableControl.prototype.addTo);goog.exportSymbol("M.impl.control.AttributeTableControl.destroy",M.impl.control.AttributeTableControl.destroy);goog.exportSymbol("M.impl.control.AttributeTableControl.PANEL_ID",M.impl.control.AttributeTableControl.PANEL_ID); })(window.M);
