...
a[b]=null;this.onSettledCallbacks_=null}};var e=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(n){f(n)}}:b}var e,f,g=new d(function(a,b){e=a;f=b});this.callWhenSettled_(c(a,e),
...
"$"),d=new RegExp(".*"+M.Layer.LEGEND_ERROR+"$"),e=a.getLegendURL();M.utils.isNullOrEmpty(e)||c.test(e)||c.test(d)||(b.classes[0]={name:"",icons:[a.getLegendURL()]})}return b};M.impl.control.Printer.prototype.encodeKML=function(a){var b=null,c=a.getImpl().getOL3Layer(),b=c.getSource().getFeatures();a=a.name;var c=c.getOpacity(),d=new ol.format.GeoJSON,e=this.facadeMap_.getBbox(),e=[e.x.min,e.y.min,e.x.max,e.y.max],f=this.facadeMap_.getMapImpl().getView().getResolution(),g=[],h={},k={},m=1;b.forEach(function(a){var b=
a.getGeometry(),c=a.get("styleUrl");M.utils.isNullOrEmpty(c)||(c=c.replace("#",""));var l=a.getStyle();if(!M.utils.isNullOrEmpty(l)&&(l=l.call(a,f)[0],!M.utils.isNullOrEmpty(l))){var n=l.getImage(),q=n.getImageSize();M.utils.isNullOrEmpty(q)&&(q=[64,64]);var w=l.getStroke(),c={id:c,externalGraphic:n.getSrc(),graphicHeight:q[0],graphicWidth:q[1],graphicOpacity:n.getOpacity(),strokeWidth:w.getWidth()},l=l.getText&&l.getText();M.utils.isNullOrEmpty(l)||(c=Object.assign(c,{label:M.utils.isNullOrEmpty(l.getText())?
a.get("name"):l.getText(),fontColor:M.utils.isNullOrEmpty(l.getFill())?"":M.utils.rgbToHex(M.utils.isArray(l.getFill().getColor())?"rgba("+l.getFill().getColor().toString()+")":l.getFill().getColor()),fontSize:"11px",fontFamily:"Helvetica, sans-serif",fontWeight:"bold",labelAlign:l.getTextAlign(),labelXOffset:l.getOffsetX(),labelYOffset:l.getOffsetY(),labelOutlineColor:M.utils.isNullOrEmpty(l.getStroke())?"":M.utils.rgbToHex(M.utils.isArray(l.getStroke().getColor())?"rgba("+l.getStroke().getColor().toString()+
")":l.getStroke().getColor()),labelOutlineWidth:M.utils.isNullOrEmpty(l.getStroke())?"":l.getStroke().getWidth()}));!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(e)&&(l=JSON.stringify(c),b=k[l],M.utils.isUndefined(b)&&(b=m,k[l]=b,h[b]=c,m++),a=d.writeFeatureObject(a),a.properties={_gx_style:b},g.push(a))}},this);return b={type:"Vector",styles:h,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",features:g},name:a,opacity:c}};M.impl.control.Printer.prototype.encodeWMS=function(a){var b,c=
a.getImpl().getOL3Layer();b=a.url;var d=c.getOpacity(),e=a.getImpl().tiled,c=c.getSource().getParams(),f=c.FORMAT,g=[c.STYLES];b={baseURL:b,opacity:d,singleTile:!e,type:"WMS",layers:(""+c.LAYERS).split(","),format:f||"image/jpeg",styles:g.join(",").split(",")};d=a.getNoChacheName();a=a.getNoChacheUrl();M.utils.isNullOrEmpty(d)||M.utils.isNullOrEmpty(a)||(b.layers=[d],b.baseURL=a);b.customParams={};for(var h in c)-1!=="iswmc,transparent".indexOf(h.toLowerCase())&&(b.customParams[h]=c[h]);return b};
M.impl.control.Printer.prototype.encodeWFS=function(a){var b=null,c=this.facadeMap_.getProjection(),b=a.getImpl().getOL3Layer(),d=b.getSource().getFeatures();a=a.name;var e=b.getOpacity(),f=b.getStyle(),g=new ol.format.GeoJSON,h=this.facadeMap_.getBbox(),h=[h.x.min,h.y.min,h.x.max,h.y.max],k=this.facadeMap_.getMapImpl().getView().getResolution(),m=[],u={},r={},t=1;d.forEach(function(a){var b=a.getGeometry(),d,e=a.getStyle();M.utils.isNullOrEmpty(e)?M.utils.isNullOrEmpty(f)||(d=f):d=e;d instanceof
Function&&(d=d.call(d,a,k));d instanceof Array&&(d=d[0]);if(!M.utils.isNullOrEmpty(d)){var l=d.getImage(),v=M.utils.isNullOrEmpty(l)?[0,0]:l.getImageSize()||[24,24],e=d.getText(),p=M.utils.isNullOrEmpty(l)?d.getStroke():l.getStroke&&l.getStroke();d=M.utils.isNullOrEmpty(l)?d.getFill():l.getFill&&l.getFill();d={fillColor:M.utils.isNullOrEmpty(d)?"":M.utils.rgbToHex(d.getColor()),fillOpacity:M.utils.isNullOrEmpty(d)?"":M.utils.getOpacityFromRgba(d.getColor()),strokeColor:M.utils.isNullOrEmpty(p)?"":
M.utils.rgbToHex(p.getColor()),strokeOpacity:M.utils.isNullOrEmpty(p)?"":M.utils.getOpacityFromRgba(p.getColor()),strokeWidth:M.utils.isNullOrEmpty(p)?"":p.getWidth&&p.getWidth(),pointRadius:M.utils.isNullOrEmpty(l)?"":l.getRadius&&l.getRadius(),externalGraphic:M.utils.isNullOrEmpty(l)?"":l.getSrc&&l.getSrc(),graphicHeight:v[0],graphicWidth:v[1]};M.utils.isNullOrEmpty(e)||(d=Object.assign(d,{label:e.getText(),fontColor:M.utils.isNullOrEmpty(e.getFill())?"":M.utils.rgbToHex(e.getFill().getColor()),
fontSize:"11px",fontFamily:"Helvetica, sans-serif",fontWeight:"bold",labelAlign:e.getTextAlign(),labelXOffset:e.getOffsetX(),labelYOffset:e.getOffsetY(),labelOutlineColor:M.utils.isNullOrEmpty(e.getStroke())?"":M.utils.rgbToHex(e.getStroke().getColor()),labelOutlineWidth:M.utils.isNullOrEmpty(e.getStroke())?"":e.getStroke().getWidth()}));!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(h)&&(e=JSON.stringify(d),b=r[e],M.utils.isUndefined(b)&&(b=t,r[e]=b,u[b]=d,t++),a="EPSG:3857"!==c.code&&this.facadeMap_.getLayers().some(function(a){return a.type===
M.layer.type.OSM||a.type===M.layer.type.Mapbox})?g.writeFeatureObject(a,{featureProjection:c.code,dataProjection:"EPSG:3857"}):g.writeFeatureObject(a),a.properties={_gx_style:b},m.push(a))}},this);return b={type:"Vector",styles:u,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",features:m},name:a,opacity:e}};M.impl.control.Printer.prototype.encodeWMTS=function(a){var b=this.facadeMap_.getZoom(),c=a.getImpl(),d=c.getOL3Layer(),e=d.getSource(),f=e.getTileGrid(),g=a.url,h=a.name,k=d.getOpacity(),
m=e.getRequestEncoding(),u=c.tiled,r=d.getExtent(),t={},l=e.getMatrixSet(),n=f.getTileSize(b),q=f.getResolutions();return a.getImpl().getCapabilities().then(function(a){a=a.Contents.TileMatrixSet.filter(function(a){return a.Identifier===l})[0];return{baseURL:g,opacity:k,singleTile:!u,type:"WMTS",layer:h,requestEncoding:m,tileSize:n,style:"deafult",rotation:0,imageFormat:"image/png",dimensionParams:{},dimensions:[],params:t,version:"1.0.0",maxExtent:r,matrixSet:l,matrixIds:a.TileMatrix.map(function(a,
b){return{identifier:a.Identifier,matrixSize:[a.MatrixHeight,a.MatrixWidth],scaleDenominator:a.ScaleDenominator,tileSize:[a.TileWidth,a.TileHeight],topLeftCorner:a.TopLeftCorner}}),resolutions:q}})};M.impl.control.Printer.prototype.encodeOSM=function(a){var b=a.getImpl(),c=b.getOL3Layer(),d=c.getSource().getTileGrid(),e=a.url||"http://tile.openstreetmap.org/";a=a.name;var c=c.getOpacity(),b=b.tiled,f=d.getExtent(),g=d.getTileSize(),d=d.getResolutions();return{baseURL:e,opacity:c,singleTile:!b,layer:a,
