...
a[b]=null;this.onSettledCallbacks_=null}};var e=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(r){f(r)}}:b}var e,f,g=new d(function(a,b){e=a;f=b});this.callWhenSettled_(c(a,e),
...
return d},"es6-impl","es3");$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};$jscomp.polyfill("Object.assign",function(a){return a?a:function(a,c){for(var b=1;b<arguments.length;b++){var e=arguments[b];if(e)for(var f in e)$jscomp.owns(e,f)&&(a[f]=e[f])}return a}},"es6-impl","es3");var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};
...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});var P={control:{}};P.control.Printer={};
(function(){M.control.Printer=function(a,b,c){M.utils.isUndefined(M.impl.control.Printer)&&M.exception("La implementaci\u00f3n usada no puede crear controles Printer");M.utils.isUndefined(M.impl.control.Printer.prototype.encodeLayer)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo encodeLayer");M.utils.isUndefined(M.impl.control.Printer.prototype.encodeLegend)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo encodeLegend");this.url_=a;this.forceScale_=this.dpi_=
this.format_=this.layout_=this.areaDescription_=this.inputTitle_=null;this.params_=b||{};this.capabilitiesPromise_=this.queueContainer_=null;this.options_=c||{};M.utils.isNullOrEmpty(this.options_.layout)&&(this.options_.layout=M.config.geoprint.TEMPLATE);M.utils.isNullOrEmpty(this.options_.dpi)&&(this.options_.dpi=M.config.geoprint.DPI);M.utils.isNullOrEmpty(this.options_.format)&&(this.options_.format=M.config.geoprint.FORMAT);M.utils.isNullOrEmpty(this.options_.forceScale)&&(this.options_.forceScale=
M.config.geoprint.FORCE_SCALE);M.utils.isNullOrEmpty(this.options_.legend)&&(this.options_.legend=M.config.geoprint.LEGEND);a=new M.impl.control.Printer;M.Control.call(this,a)};goog.inherits(M.control.Printer,M.Control);M.control.Printer.prototype.createView=function(a){var b=this;return new Promise(function(a,d){b.getCapabilities().then(function(c){var d=0,e,d=0;for(e=c.layouts.length;d<e;d++){var h=c.layouts[d];if(h.name===b.options_.layout){h.default=!0;break}}d=0;for(e=c.dpis.length;d<e;d++)if(h=
c.dpis[d],h.value==b.options_.dpi){h.default=!0;break}d=0;for(e=c.outputFormats.length;d<e;d++)if(h=c.outputFormats[d],h.name===b.options_.format){h.default=!0;break}c.forceScale=b.options_.forceScale;M.template.compile(M.control.Printer.TEMPLATE,{jsonp:!0,vars:c}).then(function(c){b.addEvents(c);a(c)})})})};M.control.Printer.prototype.addEvents=function(a){this.element_=a;this.inputTitle_=this.element_.querySelector(".form div.title > input");this.areaDescription_=this.element_.querySelector(".form div.description > textarea");
var b=this.element_.querySelector(".form div.layout > select");goog.events.listen(b,[goog.events.EventType.CHANGE],function(a){a=b.value;this.setLayout({value:a,name:a})},!1,this);a=b.value;this.setLayout({value:a,name:a});var c=this.element_.querySelector(".form div.dpi > select");goog.events.listen(c,[goog.events.EventType.CHANGE],function(a){a=c.value;this.setDpi({value:a,name:a})},!1,this);a=c.value;this.setDpi({value:a,name:a});var d=this.element_.querySelector(".form div.format > select");goog.events.listen(d,
[goog.events.EventType.CHANGE],function(a){this.setFormat(d.value)},!1,this);this.setFormat(d.value);var e=this.element_.querySelector(".form div.forcescale > input");goog.events.listen(e,goog.events.EventType.CLICK,function(a){this.setForceScale(!0===e.checked)},!1,this);this.setForceScale(!0===e.checked);a=this.element_.querySelector(".button > button.print");goog.events.listen(a,goog.events.EventType.CLICK,this.printClick_,!1,this);a=this.element_.querySelector(".button > button.remove");goog.events.listen(a,
goog.events.EventType.CLICK,function(a){a.preventDefault();this.inputTitle_.value="";this.areaDescription_.value="";b.value=this.options_.layout;c.value=this.options_.dpi;d.value=this.options_.format;e.checked=this.options_.forceScale;goog.events.getListeners(b,goog.events.EventType.CHANGE,!1).concat(goog.events.getListeners(c,goog.events.EventType.CHANGE,!1)).concat(goog.events.getListeners(d,goog.events.EventType.CHANGE,!1)).concat(goog.events.getListeners(e,goog.events.EventType.CLICK,!1)).forEach(goog.events.fireListener);
Array.prototype.forEach.apply(this.queueContainer_.children,[function(a){goog.events.unlisten(a,goog.events.EventType.CLICK,this.dowloadPrint,!1,a)},this]);goog.dom.removeChildren(this.queueContainer_)},!1,this);this.queueContainer_=this.element_.querySelector(".queue > ul.queue-container");M.utils.enableTouchScroll(this.queueContainer_)};M.control.Printer.prototype.getCapabilities=function(){if(M.utils.isNullOrEmpty(this.capabilitiesPromise_)){var a=this;this.capabilitiesPromise_=new Promise(function(b,
c){c=M.utils.concatUrlPaths([a.url_,"info.json"]);M.remote.get(c).then(function(a){var c={};try{c=JSON.parse(a.text)}catch(f){}b(c)})})}return this.capabilitiesPromise_};M.control.Printer.prototype.setLayout=function(a){this.layout_=a};M.control.Printer.prototype.setFormat=function(a){this.format_=a};M.control.Printer.prototype.setDpi=function(a){this.dpi_=a};M.control.Printer.prototype.setForceScale=function(a){this.forceScale_=a};M.control.Printer.prototype.printClick_=function(a){a.preventDefault();
var b=this;this.getCapabilities().then(function(a){b.getPrintData().then(function(c){var d=M.utils.addParameters(a.createURL,"mapeaop=geoprint"),f=b.createQueueElement();goog.dom.appendChild(b.queueContainer_,f);goog.dom.classlist.add(f,M.control.Printer.LOADING_CLASS);M.remote.post(d,c).then(function(a){goog.dom.classlist.remove(f,M.control.Printer.LOADING_CLASS);if(!0!==a.error){var c;try{a=JSON.parse(a.text),c=a.getURL}catch(k){}f.setAttribute(M.control.Printer.DOWNLOAD_ATTR_NAME,c);goog.events.listen(f,
goog.events.EventType.CLICK,b.dowloadPrint,!1,f)}else M.dialog.error("Se ha producido un error en la impresi\u00f3n")})})})};M.control.Printer.prototype.getPrintData=function(){var a=this.inputTitle_.value,b=this.areaDescription_.value,c=this.map_.getProjection(),d=M.utils.extend({units:c.units,srs:c.code,layout:this.layout_.name,dpi:this.dpi_.value,outputFormat:this.format_},this.params_.layout),e=this;return this.encodeLayers().then(function(f){d.layers=f;d.pages=e.encodePages(a,b);!0===e.options_.legend&&
(d.legends=e.encodeLegends());"EPSG:3857"!==c.code&&e.map_.getLayers().some(function(a){return a.type===M.layer.type.OSM||a.type===M.layer.type.Mapbox})&&(d.srs="EPSG:3857");return d})};M.control.Printer.prototype.encodeLayers=function(){var a=this.map_.getLayers().filter(function(a){return!0===a.isVisible()&&!0===a.inRange()&&"cluster_cover"!==a.name}),b=a.length,c=this;return new Promise(function(d,e){var f=[];a.forEach(function(a){this.getImpl().encodeLayer(a).then(function(a){null!==a&&f.push(a);
b--;0===b&&d(f)})},c)})};M.control.Printer.prototype.encodePages=function(a,b){var c=[],d=this.map_.getProjection();M.utils.isArray(this.params_.pages)||(this.params_.pages=[this.params_.pages]);this.params_.pages.forEach(function(e){e=M.utils.extend({title:a,printTitle:a,printDescription:b,infoSRS:"\n"+this.map_.getProjection().code},e);if(!1===this.forceScale_){var f=this.map_.getBbox();e.bbox=[f.x.min,f.y.min,f.x.max,f.y.max];"EPSG:3857"!==d.code&&this.map_.getLayers().some(function(a){return a.type===
M.layer.type.OSM||a.type===M.layer.type.Mapbox})&&(e.bbox=ol.proj.transformExtent(e.bbox,d.code,"EPSG:3857"))}else!0===this.forceScale_&&(f=this.map_.getCenter(),e.center=[f.x,f.y],e.scale=this.map_.getScale());e.rotation=0;c.push(e)},this);return c};M.control.Printer.prototype.encodeLegends=function(){var a=[];this.map_.getLayers().forEach(function(b){!0===b.isVisible()&&!0===b.inRange()&&(b=this.getImpl().encodeLegend(b),null!==b&&a.push(b))},this);return a};M.control.Printer.prototype.createQueueElement=
function(){var a=goog.dom.createElement("li"),b=this.inputTitle_.value;M.utils.isNullOrEmpty(b)&&(b=M.control.Printer.NO_TITLE);a.innerHTML=b;return a};M.control.Printer.prototype.dowloadPrint=function(a){a.preventDefault();a=this.getAttribute(M.control.Printer.DOWNLOAD_ATTR_NAME);M.utils.isNullOrEmpty(a)||window.open(a,"_blank")};M.control.Printer.prototype.equals=function(a){var b=!1;a instanceof M.control.Printer&&(b=this.name===a.name);return b};M.control.Printer.TEMPLATE="printer.html";M.control.Printer.LOADING_CLASS=
"printing";M.control.Printer.DOWNLOAD_ATTR_NAME="data-donwload-url-print";M.control.Printer.NO_TITLE="(Sin t\u00edtulo)"})();P.plugin={};P.plugin.Printer={};
(function(){M.plugin.Printer=function(a){a=a||{};this.panel_=this.control_=this.map_=null;this.name=M.plugin.Printer.NAME;this.url_=M.config.geoprint.URL;M.utils.isNullOrEmpty(a.url)||(this.url_=a.url);this.params_={};M.utils.isNullOrEmpty(a.params)||(this.params_=a.params);this.options_={};M.utils.isNullOrEmpty(a.options)||(this.options_=a.options);M.Plugin.call(this,null,M.plugin.Printer.NAME)};goog.inherits(M.plugin.Printer,M.Plugin);M.plugin.Printer.prototype.addTo=function(a){this.map_=a;this.control_=
new M.control.Printer(this.url_,this.params_,this.options_);this.panel_=new M.ui.Panel("printer",{collapsible:!0,className:"m-printer",collapsedButtonClass:"g-cartografia-impresora",position:M.ui.position.TR,tooltip:"Impresi\u00f3n del mapa"});this.panel_.on(M.evt.ADDED_TO_MAP,function(a){M.utils.enableTouchScroll(a)});this.panel_.addControls(this.control_);this.map_.addPanels(this.panel_);var b=this;this.control_.on(M.evt.ADDED_TO_MAP,function(){b.fire(M.evt.ADDED_TO_MAP)})};M.plugin.Printer.prototype.destroy=
function(){this.map_.removeControls([this.control_]);this.name=this.options_=this.params_=this.url_=this.panel_=this.control_=this.map_=null};M.plugin.Printer.prototype.equals=function(a){return a instanceof M.plugin.Printer?!0:!1};M.plugin.Printer.NAME="printer"})();P.impl={};P.impl.control={};P.impl.control.Printer={};
(function(){M.impl.control.Printer=function(){this.facadeMap_=null};goog.inherits(M.impl.control.Printer,M.impl.Control);M.impl.control.Printer.prototype.addTo=function(a,b){this.facadeMap_=a;ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Printer.prototype.encodeLayer=function(a){var b=this;return new Promise(function(c,d){a.type!==M.layer.type.WMC&&(a.type===M.layer.type.KML?c(b.encodeKML(a)):a.type===M.layer.type.WMS?c(b.encodeWMS(a)):a.type===
M.layer.type.WFS?c(b.encodeWFS(a)):a.type===M.layer.type.GeoJSON?c(b.encodeWFS(a)):a.type===M.layer.type.WMTS?b.encodeWMTS(a).then(function(a){c(a)}):a.type!==M.layer.type.MBtiles&&(a.type===M.layer.type.OSM?c(b.encodeOSM(a)):a.type===M.layer.type.Mapbox?c(b.encodeMapbox(a)):(M.utils.isNullOrEmpty(a.type),c(b.encodeWFS(a)))))})};M.impl.control.Printer.prototype.encodeLegend=function(a){var b=null;if(a.displayInLayerSwitcher){var b={name:a.name,classes:[]},c=new RegExp(".*"+M.Layer.LEGEND_DEFAULT+
"$"),d=new RegExp(".*"+M.Layer.LEGEND_ERROR+"$"),e=a.getLegendURL();M.utils.isNullOrEmpty(e)||c.test(e)||c.test(d)||(b.classes[0]={name:"",icons:[a.getLegendURL()]},a instanceof M.layer.Vector&&delete b.classes[0].icons)}return b};M.impl.control.Printer.prototype.encodeKML=function(a){var b=null,c=a.getImpl().getOL3Layer(),b=c.getSource().getFeatures();a=a.name;var c=c.getOpacity(),d=new ol.format.GeoJSON,e=this.facadeMap_.getBbox(),e=[e.x.min,e.y.min,e.x.max,e.y.max],f=this.facadeMap_.getMapImpl().getView().getResolution(),
g=[],h={},k={},n=1;b.forEach(function(a){var b=a.getGeometry(),c=a.get("styleUrl");M.utils.isNullOrEmpty(c)||(c=c.replace("#",""));var l=a.getStyle();if(!M.utils.isNullOrEmpty(l)&&(l=l.call(a,f)[0],!M.utils.isNullOrEmpty(l))){var r=l.getImage(),t=r.getImageSize();M.utils.isNullOrEmpty(t)&&(t=[64,64]);var x=l.getStroke(),c={id:c,externalGraphic:r.getSrc(),graphicHeight:t[0],graphicWidth:t[1],graphicOpacity:r.getOpacity(),strokeWidth:x.getWidth()},l=l.getText&&l.getText();M.utils.isNullOrEmpty(l)||
(c=Object.assign(c,{label:M.utils.isNullOrEmpty(l.getText())?a.get("name"):l.getText(),fontColor:M.utils.isNullOrEmpty(l.getFill())?"":M.utils.rgbToHex(M.utils.isArray(l.getFill().getColor())?"rgba("+l.getFill().getColor().toString()+")":l.getFill().getColor()),fontSize:"11px",fontFamily:"Helvetica, sans-serif",fontWeight:"bold",labelAlign:l.getTextAlign(),labelXOffset:l.getOffsetX(),labelYOffset:l.getOffsetY(),labelOutlineColor:M.utils.isNullOrEmpty(l.getStroke())?"":M.utils.rgbToHex(M.utils.isArray(l.getStroke().getColor())?
"rgba("+l.getStroke().getColor().toString()+")":l.getStroke().getColor()),labelOutlineWidth:M.utils.isNullOrEmpty(l.getStroke())?"":l.getStroke().getWidth()}));!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(e)&&(l=JSON.stringify(c),b=k[l],M.utils.isUndefined(b)&&(b=n,k[l]=b,h[b]=c,n++),a=d.writeFeatureObject(a),a.properties={_gx_style:b},g.push(a))}},this);return b={type:"Vector",styles:h,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",features:g},name:a,opacity:c}};M.impl.control.Printer.prototype.encodeWMS=
function(a){var b,c=a.getImpl().getOL3Layer();b=a.url;var d=c.getOpacity(),e=a.getImpl().tiled,c=c.getSource().getParams(),f=c.FORMAT,g=[c.STYLES];b={baseURL:b,opacity:d,singleTile:!e,type:"WMS",layers:(""+c.LAYERS).split(","),format:f||"image/jpeg",styles:g.join(",").split(",")};d=a.getNoChacheName();a=a.getNoChacheUrl();M.utils.isNullOrEmpty(d)||M.utils.isNullOrEmpty(a)||(b.layers=[d],b.baseURL=a);b.customParams={};for(var h in c)-1!=="iswmc,transparent".indexOf(h.toLowerCase())&&(b.customParams[h]=
c[h]);return b};M.impl.control.Printer.prototype.encodeWFS=function(a){var b=null,c=!0;a.getStyle()instanceof M.style.Chart?c=!1:a.getStyle()instanceof M.style.Cluster&&a.getStyle().getOldStyle()instanceof M.style.Chart&&(c=!1);if(c){var d=this.facadeMap_.getProjection(),b=a.getImpl().getOL3Layer(),c=b.getSource().getFeatures();a=a.name;var e=b.getOpacity(),f=b.getStyle(),g=new ol.format.GeoJSON,h=this.facadeMap_.getBbox(),h=[h.x.min,h.y.min,h.x.max,h.y.max],k=this.facadeMap_.getMapImpl().getView().getResolution(),
n=[],w={},u={},v=1;c.forEach(function(a){var b=a.getGeometry(),c,e=a.getStyle();M.utils.isNullOrEmpty(e)?M.utils.isNullOrEmpty(f)||(c=f):c=e;c instanceof Function&&(c=c.call(c,a,k));c instanceof Array&&(c=1<c.length?!M.utils.isNullOrEmpty(c[1].getImage())&&c[1].getImage().getSrc?c[1]:c[0]:c[0]);if(!M.utils.isNullOrEmpty(c)){var l=c.getImage(),p=M.utils.isNullOrEmpty(l)?[0,0]:l.getImageSize()||[24,24],e=c.getText();M.utils.isNullOrEmpty(e)&&!M.utils.isNullOrEmpty(c.textPath)&&(e=c.textPath);var m=
M.utils.isNullOrEmpty(l)?c.getStroke():l.getStroke&&l.getStroke();c=M.utils.isNullOrEmpty(l)?c.getFill():l.getFill&&l.getFill();c={fillColor:M.utils.isNullOrEmpty(c)?"#000000":M.utils.rgbaToHex(c.getColor()),fillOpacity:M.utils.isNullOrEmpty(c)?1:M.utils.getOpacityFromRgba(c.getColor()),strokeColor:M.utils.isNullOrEmpty(m)?"#000000":M.utils.rgbaToHex(m.getColor()),strokeOpacity:M.utils.isNullOrEmpty(m)?0:M.utils.getOpacityFromRgba(m.getColor()),strokeWidth:M.utils.isNullOrEmpty(m)?0:m.getWidth&&m.getWidth(),
pointRadius:M.utils.isNullOrEmpty(l)?"":l.getRadius&&l.getRadius(),externalGraphic:M.utils.isNullOrEmpty(l)?"":l.getSrc&&l.getSrc(),graphicHeight:p[0],graphicWidth:p[1]};if(!M.utils.isNullOrEmpty(e)){p=e.getTextAlign();m=e.getTextBaseline();l="";M.utils.isNullOrEmpty(p)||(p=p===M.style.align.LEFT?"l":p===M.style.align.RIGHT?"r":p===M.style.align.CENTER?"c":"");M.utils.isNullOrEmpty(m)||(m=m===M.style.baseline.BOTTOM?"b":m===M.style.baseline.MIDDLE?"m":m===M.style.baseline.TOP?"t":"");M.utils.isNullOrEmpty(p)||
M.utils.isNullOrEmpty(m)||(l=p.concat(m));var q=e.getFont(),p=!M.utils.isNullOrEmpty(q)&&-1<q.indexOf("bold")?"bold":"normal",m="11px";M.utils.isNullOrEmpty(q)||(q=q.substr(0,q.indexOf("px")),M.utils.isNullOrEmpty(q)||(m=q.lastIndexOf(" "),m=-1<m?q.substr(m,q.length).trim().concat("px"):q.concat("px")));c=Object.assign(c,{label:e.getText(),fontColor:M.utils.isNullOrEmpty(e.getFill())?"#000000":M.utils.rgbToHex(e.getFill().getColor()),fontSize:m,fontFamily:"Helvetica, sans-serif",fontStyle:"normal",
fontWeight:p,labelXOffset:e.getOffsetX(),labelYOffset:e.getOffsetY(),fillColor:c.fillColor||"#FF0000",fillOpacity:c.fillOpacity||1,"labelOutlineColor ":M.utils.isNullOrEmpty(e.getStroke())?"":M.utils.rgbToHex(e.getStroke().getColor()||"#FF0000"),labelOutlineWidth:M.utils.isNullOrEmpty(e.getStroke())?"":e.getStroke().getWidth(),labelAlign:l})}!M.utils.isNullOrEmpty(b)&&b.intersectsExtent(h)&&(e=JSON.stringify(c),b=u[e],M.utils.isUndefined(b)&&(b=v,u[e]=b,w[b]=c,v++),a="EPSG:3857"!==d.code&&this.facadeMap_.getLayers().some(function(a){return a.type===
M.layer.type.OSM||a.type===M.layer.type.Mapbox})?g.writeFeatureObject(a,{featureProjection:d.code,dataProjection:"EPSG:3857"}):g.writeFeatureObject(a),a.properties={_gx_style:b},n.push(a))}},this);b={type:"Vector",styles:w,styleProperty:"_gx_style",geoJson:{type:"FeatureCollection",features:n},name:a,opacity:e}}return b};M.impl.control.Printer.prototype.encodeWMTS=function(a){var b=this.facadeMap_.getZoom(),c=a.getImpl(),d=c.getOL3Layer(),e=d.getSource(),f=e.getTileGrid(),g=a.url,h=a.name,k=d.getOpacity(),
n=e.getRequestEncoding(),w=c.tiled,u=d.getExtent(),v={},l=e.getMatrixSet(),r=f.getTileSize(b),t=f.getResolutions();return a.getImpl().getCapabilities().then(function(a){a=a.Contents.TileMatrixSet.filter(function(a){return a.Identifier===l})[0];return{baseURL:g,opacity:k,singleTile:!w,type:"WMTS",layer:h,requestEncoding:n,tileSize:r,style:"deafult",rotation:0,imageFormat:"image/png",dimensionParams:{},dimensions:[],params:v,version:"1.0.0",maxExtent:u,matrixSet:l,matrixIds:a.TileMatrix.map(function(a,
b){return{identifier:a.Identifier,matrixSize:[a.MatrixHeight,a.MatrixWidth],scaleDenominator:a.ScaleDenominator,tileSize:[a.TileWidth,a.TileHeight],topLeftCorner:a.TopLeftCorner}}),resolutions:t}})};M.impl.control.Printer.prototype.encodeOSM=function(a){var b=a.getImpl(),c=b.getOL3Layer(),d=c.getSource().getTileGrid(),e=a.url||"http://tile.openstreetmap.org/";a=a.name;var c=c.getOpacity(),b=b.tiled,f=d.getExtent(),g=d.getTileSize(),d=d.getResolutions();return{baseURL:e,opacity:c,singleTile:!b,layer:a,
maxExtent:f,tileSize:[g,g],resolutions:d,type:"OSM",extension:"png"}};M.impl.control.Printer.prototype.encodeMapbox=function(a){var b=a.getImpl().getOL3Layer(),c=b.getSource().getTileGrid();a=M.utils.concatUrlPaths([M.config.MAPBOX_URL,a.name]);var b=b.getOpacity(),d=c.getExtent(),e=c.getTileSize(),c=c.getResolutions(),f={};f[M.config.MAPBOX_TOKEN_NAME]=M.config.MAPBOX_TOKEN_VALUE;return{opacity:b,baseURL:a,customParams:f,maxExtent:d,tileSize:[e,e],resolutions:c,extension:M.config.MAPBOX_EXTENSION,
type:"xyz",path_format:"/${z}/${x}/${y}.png"}};M.impl.control.Printer.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_=null}})();goog.exportSymbol("M.plugin.Printer",M.plugin.Printer);goog.exportProperty(M.plugin.Printer.prototype,"name",M.plugin.Printer.prototype.name);goog.exportProperty(M.plugin.Printer.prototype,"addTo",M.plugin.Printer.prototype.addTo);goog.exportProperty(M.plugin.Printer.prototype,"destroy",M.plugin.Printer.prototype.destroy);goog.exportProperty(M.plugin.Printer.prototype,"equals",M.plugin.Printer.prototype.equals);goog.exportSymbol("M.plugin.Printer.NAME",M.plugin.Printer.NAME);
goog.exportSymbol("M.impl.control.Printer",M.impl.control.Printer);goog.exportProperty(M.impl.control.Printer.prototype,"addTo",M.impl.control.Printer.prototype.addTo);goog.exportProperty(M.impl.control.Printer.prototype,"encodeLayer",M.impl.control.Printer.prototype.encodeLayer);goog.exportProperty(M.impl.control.Printer.prototype,"encodeLegend",M.impl.control.Printer.prototype.encodeLegend);goog.exportProperty(M.impl.control.Printer.prototype,"encodeKML",M.impl.control.Printer.prototype.encodeKML);
goog.exportProperty(M.impl.control.Printer.prototype,"encodeWMS",M.impl.control.Printer.prototype.encodeWMS);goog.exportProperty(M.impl.control.Printer.prototype,"encodeWFS",M.impl.control.Printer.prototype.encodeWFS);goog.exportProperty(M.impl.control.Printer.prototype,"encodeWMTS",M.impl.control.Printer.prototype.encodeWMTS);goog.exportProperty(M.impl.control.Printer.prototype,"encodeOSM",M.impl.control.Printer.prototype.encodeOSM);
goog.exportProperty(M.impl.control.Printer.prototype,"encodeMapbox",M.impl.control.Printer.prototype.encodeMapbox);goog.exportProperty(M.impl.control.Printer.prototype,"destroy",M.impl.control.Printer.prototype.destroy);goog.exportSymbol("M.control.Printer",M.control.Printer);goog.exportProperty(M.control.Printer.prototype,"createView",M.control.Printer.prototype.createView);goog.exportProperty(M.control.Printer.prototype,"addEvents",M.control.Printer.prototype.addEvents);
goog.exportProperty(M.control.Printer.prototype,"getCapabilities",M.control.Printer.prototype.getCapabilities);goog.exportProperty(M.control.Printer.prototype,"createQueueElement",M.control.Printer.prototype.createQueueElement);goog.exportProperty(M.control.Printer.prototype,"dowloadPrint",M.control.Printer.prototype.dowloadPrint);goog.exportProperty(M.control.Printer.prototype,"equals",M.control.Printer.prototype.equals);goog.exportSymbol("M.control.Printer.TEMPLATE",M.control.Printer.TEMPLATE);
goog.exportSymbol("M.control.Printer.LOADING_CLASS",M.control.Printer.LOADING_CLASS);goog.exportSymbol("M.control.Printer.DOWNLOAD_ATTR_NAME",M.control.Printer.DOWNLOAD_ATTR_NAME);goog.exportSymbol("M.control.Printer.NO_TITLE",M.control.Printer.NO_TITLE); })(window.M);
