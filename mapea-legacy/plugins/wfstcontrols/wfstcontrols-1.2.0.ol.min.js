...
this.modify=null};M.impl.control.ModifyFeature.prototype.createInteractionModify_=function(){var a=this.facadeMap_.getMapImpl(),b=this.layer_.getImpl().getOL3Layer(),c=b.getStyle()()[0],d=c.getImage(),e=$jscomp.makeIterator([c.getFill(),c.getStroke()]),c=e.next().value,e=e.next().value;null!=d&&(e=d.getStroke());var f=null==e?null:e.clone();null!=f&&f.setColor(M.utils.getRgba(e.getColor()));null==d&&(d=new ol.style.Circle({fill:c||f,radius:5,stroke:e}));b=new ol.Collection(b.getSource().getFeatures());
b.forEach(function(a){a.on("change",function(a){this.currentFeature_=a.target},this)},this);this.modify=new ol.interaction.Modify({features:b,deleteCondition:function(a){return ol.events.condition.shiftKeyOnly(a)&&ol.events.condition.singleClick(a)},style:new ol.style.Style({image:d})});this.modify.on("modifyend",function(a){a=this.modifiedFeatures.indexOf(this.currentFeature_);0<=a?this.modifiedFeatures[a]=this.currentFeature_:this.modifiedFeatures.push(this.currentFeature_);this.currentFeature_=
null},this);a.addInteraction(this.modify);this.layer_.on(M.evt.LOAD,this.updateLayerFeatures_,this)};M.impl.control.ModifyFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.modify);this.modify=null};M.impl.control.ModifyFeature.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.modify=this.layer_=null;this.modifiedFeatures=[]}})();goog.dom.xml={};goog.dom.xml.MAX_XML_SIZE_KB=2048;goog.dom.xml.MAX_ELEMENT_DEPTH=256;goog.dom.xml.hasActiveXObjectSupport_=function(){if(!goog.userAgent.IE)return!1;try{return new ActiveXObject("MSXML2.DOMDocument"),!0}catch(a){return!1}};goog.dom.xml.ACTIVEX_SUPPORT=goog.userAgent.IE&&goog.dom.xml.hasActiveXObjectSupport_();
...
a.set(b.geometryName,f);a.setGeometryName(b.geometryName);a.setGeometry(f);a.unset(d);b.properties.forEach(function(b){if(!M.utils.isGeometryType(b.localType)){var d=a.getProperties()[b.name]||c.getDefaultValue(b.localType);a.set(b.name,d)}})})}})();goog.exportSymbol("M.impl.control.ClearFeature",M.impl.control.ClearFeature);goog.exportProperty(M.impl.control.ClearFeature.prototype,"addTo",M.impl.control.ClearFeature.prototype.addTo);goog.exportProperty(M.impl.control.ClearFeature.prototype,"clear",M.impl.control.ClearFeature.prototype.clear);goog.exportProperty(M.impl.control.ClearFeature.prototype,"destroy",M.impl.control.ClearFeature.prototype.destroy);goog.exportSymbol("M.control.ClearFeature",M.control.ClearFeature);
goog.exportProperty(M.control.ClearFeature.prototype,"createView",M.control.ClearFeature.prototype.createView);goog.exportProperty(M.control.ClearFeature.prototype,"manageActivation",M.control.ClearFeature.prototype.manageActivation);goog.exportProperty(M.control.ClearFeature.prototype,"equals",M.control.ClearFeature.prototype.equals);goog.exportProperty(M.control.ClearFeature.prototype,"setLayer",M.control.ClearFeature.prototype.setLayer);goog.exportSymbol("M.control.ClearFeature.NAME",M.control.ClearFeature.NAME);
goog.exportSymbol("M.control.ClearFeature.TEMPLATE",M.control.ClearFeature.TEMPLATE);goog.exportSymbol("M.impl.control.DeleteFeature",M.impl.control.DeleteFeature);goog.exportProperty(M.impl.control.DeleteFeature.prototype,"modifiedFeatures",M.impl.control.DeleteFeature.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.DeleteFeature.prototype,"activate",M.impl.control.DeleteFeature.prototype.activate);goog.exportProperty(M.impl.control.DeleteFeature.prototype,"deactivate",M.impl.control.DeleteFeature.prototype.deactivate);
goog.exportSymbol("M.control.DeleteFeature",M.control.DeleteFeature);goog.exportProperty(M.control.DeleteFeature.prototype,"createView",M.control.DeleteFeature.prototype.createView);goog.exportProperty(M.control.DeleteFeature.prototype,"getActivationButton",M.control.DeleteFeature.prototype.getActivationButton);goog.exportProperty(M.control.DeleteFeature.prototype,"equals",M.control.DeleteFeature.prototype.equals);goog.exportProperty(M.control.DeleteFeature.prototype,"setLayer",M.control.DeleteFeature.prototype.setLayer);
goog.exportSymbol("M.control.DeleteFeature.NAME",M.control.DeleteFeature.NAME);goog.exportSymbol("M.control.DeleteFeature.TEMPLATE",M.control.DeleteFeature.TEMPLATE);goog.exportSymbol("M.impl.control.DrawFeature",M.impl.control.DrawFeature);goog.exportProperty(M.impl.control.DrawFeature.prototype,"createInteraction_",M.impl.control.DrawFeature.prototype.createInteraction_);goog.exportProperty(M.impl.control.DrawFeature.prototype,"deactivate",M.impl.control.DrawFeature.prototype.deactivate);
goog.exportSymbol("M.control.DrawFeature",M.control.DrawFeature);goog.exportProperty(M.control.DrawFeature.prototype,"createView",M.control.DrawFeature.prototype.createView);goog.exportProperty(M.control.DrawFeature.prototype,"getActivationButton",M.control.DrawFeature.prototype.getActivationButton);goog.exportProperty(M.control.DrawFeature.prototype,"equals",M.control.DrawFeature.prototype.equals);goog.exportProperty(M.control.DrawFeature.prototype,"setLayer",M.control.DrawFeature.prototype.setLayer);
...
goog.exportSymbol("M.impl.control.EditAttribute.SELECTED_STYLE",M.impl.control.EditAttribute.SELECTED_STYLE);goog.exportSymbol("M.control.EditAttribute",M.control.EditAttribute);goog.exportProperty(M.control.EditAttribute.prototype,"createView",M.control.EditAttribute.prototype.createView);goog.exportProperty(M.control.EditAttribute.prototype,"getActivationButton",M.control.EditAttribute.prototype.getActivationButton);goog.exportProperty(M.control.EditAttribute.prototype,"equals",M.control.EditAttribute.prototype.equals);
goog.exportProperty(M.control.EditAttribute.prototype,"setLayer",M.control.EditAttribute.prototype.setLayer);goog.exportSymbol("M.control.EditAttribute.NAME",M.control.EditAttribute.NAME);goog.exportSymbol("M.control.EditAttribute.POPUP_TITLE",M.control.EditAttribute.POPUP_TITLE);goog.exportSymbol("M.control.EditAttribute.TEMPLATE",M.control.EditAttribute.TEMPLATE);goog.exportSymbol("M.control.EditAttribute.TEMPLATE_POPUP",M.control.EditAttribute.TEMPLATE_POPUP);
goog.exportSymbol("M.impl.control.ModifyFeature",M.impl.control.ModifyFeature);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modify",M.impl.control.ModifyFeature.prototype.modify);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modifiedFeatures",M.impl.control.ModifyFeature.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"activate",M.impl.control.ModifyFeature.prototype.activate);
goog.exportProperty(M.impl.control.ModifyFeature.prototype,"deactivate",M.impl.control.ModifyFeature.prototype.deactivate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"destroy",M.impl.control.ModifyFeature.prototype.destroy);goog.exportSymbol("M.control.ModifyFeature",M.control.ModifyFeature);goog.exportProperty(M.control.ModifyFeature.prototype,"createView",M.control.ModifyFeature.prototype.createView);goog.exportProperty(M.control.ModifyFeature.prototype,"getActivationButton",M.control.ModifyFeature.prototype.getActivationButton);
goog.exportProperty(M.control.ModifyFeature.prototype,"equals",M.control.ModifyFeature.prototype.equals);goog.exportProperty(M.control.ModifyFeature.prototype,"setLayer",M.control.ModifyFeature.prototype.setLayer);goog.exportSymbol("M.control.ModifyFeature.NAME",M.control.ModifyFeature.NAME);goog.exportSymbol("M.control.ModifyFeature.TEMPLATE",M.control.ModifyFeature.TEMPLATE);goog.exportSymbol("M.impl.control.SaveFeature",M.impl.control.SaveFeature);
goog.exportProperty(M.impl.control.SaveFeature.prototype,"addTo",M.impl.control.SaveFeature.prototype.addTo);goog.exportProperty(M.impl.control.SaveFeature.prototype,"saveFeature",M.impl.control.SaveFeature.prototype.saveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"destroy",M.impl.control.SaveFeature.prototype.destroy);goog.exportSymbol("M.impl.control.SaveFeature.applyDescribeFeatureType",M.impl.control.SaveFeature.applyDescribeFeatureType);
...
goog.exportProperty(M.impl.control.WFSTBase.prototype,"addTo",M.impl.control.WFSTBase.prototype.addTo);goog.exportProperty(M.impl.control.WFSTBase.prototype,"activate",M.impl.control.WFSTBase.prototype.activate);goog.exportProperty(M.impl.control.WFSTBase.prototype,"deactivate",M.impl.control.WFSTBase.prototype.deactivate);goog.exportProperty(M.impl.control.WFSTBase.prototype,"destroy",M.impl.control.WFSTBase.prototype.destroy);goog.exportSymbol("M.plugin.WFSTControls",M.plugin.WFSTControls);
goog.exportProperty(M.plugin.WFSTControls.prototype,"name",M.plugin.WFSTControls.prototype.name);goog.exportProperty(M.plugin.WFSTControls.prototype,"addTo",M.plugin.WFSTControls.prototype.addTo);goog.exportProperty(M.plugin.WFSTControls.prototype,"destroy",M.plugin.WFSTControls.prototype.destroy);goog.exportProperty(M.plugin.WFSTControls.prototype,"setLayer",M.plugin.WFSTControls.prototype.setLayer);goog.exportProperty(M.plugin.WFSTControls.prototype,"equals",M.plugin.WFSTControls.prototype.equals);
goog.exportSymbol("M.plugin.WFSTControls.NAME",M.plugin.WFSTControls.NAME);goog.exportProperty(M.impl.control.DrawFeature.prototype,"modifiedFeatures",M.impl.control.DrawFeature.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.DrawFeature.prototype,"addTo",M.impl.control.DrawFeature.prototype.addTo);goog.exportProperty(M.impl.control.DrawFeature.prototype,"activate",M.impl.control.DrawFeature.prototype.activate);goog.exportProperty(M.impl.control.DrawFeature.prototype,"destroy",M.impl.control.DrawFeature.prototype.destroy); })(window.M);
