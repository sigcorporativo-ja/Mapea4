...
(function(){M.impl.control.DrawFeature=function(a){M.impl.control.WFSTBase.call(this,a)};goog.inherits(M.impl.control.DrawFeature,M.impl.control.WFSTBase);M.impl.control.DrawFeature.prototype.createInteraction_=function(){var a=this.layer_.getImpl().getOL3Layer();this.interaction_=new ol.interaction.Draw({source:a.getSource(),type:M.geom.parseWFS(this.layer_.geometry),style:a.getStyle()});this.interaction_.on("drawend",function(a){this.modifiedFeatures.push(a.feature)},this);this.layer_.on(M.evt.LOAD,
this.updateLayerFeatures_,this)};M.impl.control.DrawFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.interaction_);this.interaction_=null}})();P.impl.control.EditAttribute={};
...
this.modify=null};M.impl.control.ModifyFeature.prototype.createInteractionModify_=function(){var a=this.facadeMap_.getMapImpl(),b=this.layer_.getImpl().getOL3Layer(),c=new ol.Collection(b.getSource().getFeatures());c.forEach(function(a){a.on("change",function(a){this.currentFeature_=a.target},this)},this);this.modify=new ol.interaction.Modify({features:c,deleteCondition:function(a){return ol.events.condition.shiftKeyOnly(a)&&ol.events.condition.singleClick(a)},style:b.getStyle()});this.modify.on("modifyend",
...
goog.exportSymbol("M.control.ClearFeature.NAME",M.control.ClearFeature.NAME);goog.exportSymbol("M.control.ClearFeature.TEMPLATE",M.control.ClearFeature.TEMPLATE);goog.exportSymbol("M.control.DeleteFeature",M.control.DeleteFeature);goog.exportProperty(M.control.DeleteFeature.prototype,"createView",M.control.DeleteFeature.prototype.createView);goog.exportProperty(M.control.DeleteFeature.prototype,"getActivationButton",M.control.DeleteFeature.prototype.getActivationButton);
goog.exportProperty(M.control.DeleteFeature.prototype,"equals",M.control.DeleteFeature.prototype.equals);goog.exportProperty(M.control.DeleteFeature.prototype,"setLayer",M.control.DeleteFeature.prototype.setLayer);goog.exportSymbol("M.control.DeleteFeature.NAME",M.control.DeleteFeature.NAME);goog.exportSymbol("M.control.DeleteFeature.TEMPLATE",M.control.DeleteFeature.TEMPLATE);goog.exportSymbol("M.control.DrawFeature",M.control.DrawFeature);
...
goog.exportSymbol("M.control.ModifyFeature.NAME",M.control.ModifyFeature.NAME);goog.exportSymbol("M.control.ModifyFeature.TEMPLATE",M.control.ModifyFeature.TEMPLATE);goog.exportSymbol("M.control.SaveFeature",M.control.SaveFeature);goog.exportProperty(M.control.SaveFeature.prototype,"createView",M.control.SaveFeature.prototype.createView);goog.exportProperty(M.control.SaveFeature.prototype,"equals",M.control.SaveFeature.prototype.equals);
goog.exportProperty(M.control.SaveFeature.prototype,"manageActivation",M.control.SaveFeature.prototype.manageActivation);goog.exportProperty(M.control.SaveFeature.prototype,"saveFeature_",M.control.SaveFeature.prototype.saveFeature_);goog.exportProperty(M.control.SaveFeature.prototype,"setLayer",M.control.SaveFeature.prototype.setLayer);goog.exportSymbol("M.control.SaveFeature.NAME",M.control.SaveFeature.NAME);goog.exportSymbol("M.control.SaveFeature.TEMPLATE",M.control.SaveFeature.TEMPLATE);
