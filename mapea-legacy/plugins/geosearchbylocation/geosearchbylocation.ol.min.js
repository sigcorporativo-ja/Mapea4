...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});var P={layer:{}};P.layer.Geosearch={};(function(){M.layer.Geosearch=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?new M.impl.layer.Geosearch:c;M.utils.isUndefined(M.impl.layer.Geosearch)&&M.exception("La implementaci\u00f3n usada no puede crear capas Geosearch");M.layer.Vector.call(this,this,b,c)};goog.inherits(M.layer.Geosearch,M.layer.Vector);M.layer.Geosearch.prototype.equals=function(a){return!1}})();P.control={};P.control.Geosearch={};
...
this.panel_.addClassName("m-with-location m-with-streetview"));this.panel_.addControls(this.controlGeo);this.map_.addPanels(this.panel_)};M.plugin.Geosearchbylocation.prototype.destroy=function(){this.map_.removeControls([this.controlGeo]);this.panel_=this.controlGeo=this.map_=this.rows_=this.spatialField_=this.distance_=this.handler_=this.core_=this.url_=this.name=this.controlGeo=null};M.plugin.Geosearchbylocation.NAME="geosearchbylocation";M.plugin.Geosearchbylocation.prototype.equals=function(a){return a instanceof
M.plugin.Geosearchbylocation?!0:!1}})();P.impl.control.Geosearchbylocation={};
...
function(){var a=new ol.Geolocation({projection:this.facadeMap_.getMapImpl().getView().getProjection()});a.setTracking(!0);this.positionFeature_=M.impl.Feature.olFeature2Facade(new ol.Feature);this.positionFeature_.getImpl().getOLFeature().setStyle(new ol.style.Style({image:new ol.style.Circle({radius:6,fill:new ol.style.Fill({color:"#3399CC"}),stroke:new ol.style.Stroke({color:"#fff",width:2})})}));var b=this,c;this.positionFeature_.click=function(a){M.template.compile(M.impl.control.Geosearchbylocation.POPUP_LOCATION,
{jsonp:!0,vars:{valorX:c[0],valorY:c[1]},parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-gps2",title:"posici\u00f3n",content:a};b.popup_=b.facadeMap_.getPopup();M.utils.isNullOrEmpty(b.popup_)?(b.popup_=new M.Popup,b.popup_.addTab(a),b.facadeMap_.addPopup(b.popup_,c)):b.popup_.addTab(a)})};return new Promise(function(b,e){a.on("change:position",function(){a.setTracking(!1);c=a.getPosition();b(c)},this)})};M.impl.control.Geosearch.prototype.removeLocate=function(){this.facadeMap_.removeFeatures([this.positionFeature_])};
M.impl.control.Geosearchbylocation.prototype.drawLocation=function(a){this.positionFeature_.getImpl().getOLFeature().setGeometry(a?new ol.geom.Point(a):null);this.facadeMap_.drawFeatures([this.positionFeature_])};M.impl.control.Geosearchbylocation.prototype.addResultsContainer=function(a){var b=this.map.getTargetElement();goog.dom.appendChild(b,a)};M.impl.control.Geosearchbylocation.prototype.removeResultsContainer=function(a){goog.dom.removeNode(a)};M.impl.control.Geosearchbylocation.prototype.zoomToResultsAll=
function(){var a=this.facadeMap_.getControls("geosearchbylocation")[0].getImpl().getLayer().getFeaturesExtent();this.facadeMap_.setBbox(a)};M.impl.control.Geosearchbylocation.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.clear();this.facadeMap_.removeFeatures([this.positionFeature_]);this.searchUrl_=this.popup_=null};M.impl.control.Geosearchbylocation.POPUP_LOCATION="geosearchbylocationfeaturepopup.html"})();goog.exportSymbol("M.plugin.Geosearchbylocation",M.plugin.Geosearchbylocation);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"name",M.plugin.Geosearchbylocation.prototype.name);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"controlGeo",M.plugin.Geosearchbylocation.prototype.controlGeo);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"addTo",M.plugin.Geosearchbylocation.prototype.addTo);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"destroy",M.plugin.Geosearchbylocation.prototype.destroy);
goog.exportSymbol("M.plugin.Geosearchbylocation.NAME",M.plugin.Geosearchbylocation.NAME);goog.exportProperty(M.plugin.Geosearchbylocation.prototype,"equals",M.plugin.Geosearchbylocation.prototype.equals);goog.exportSymbol("M.control.Geosearchbylocation",M.control.Geosearchbylocation);goog.exportProperty(M.control.Geosearchbylocation.prototype,"equals",M.control.Geosearchbylocation.prototype.equals);goog.exportProperty(M.control.Geosearchbylocation.prototype,"createView",M.control.Geosearchbylocation.prototype.createView);
goog.exportProperty(M.control.Geosearchbylocation.prototype,"getActivationButton",M.control.Geosearchbylocation.prototype.getActivationButton);goog.exportProperty(M.control.Geosearchbylocation.prototype,"activate",M.control.Geosearchbylocation.prototype.activate);goog.exportProperty(M.control.Geosearchbylocation.prototype,"deactivate",M.control.Geosearchbylocation.prototype.deactivate);goog.exportSymbol("M.control.Geosearchbylocation.NAME",M.control.Geosearchbylocation.NAME);
goog.exportSymbol("M.control.Geosearchbylocation.HIDDEN",M.control.Geosearchbylocation.HIDDEN);goog.exportSymbol("M.control.Geosearchbylocation.TEMPLATE",M.control.Geosearchbylocation.TEMPLATE);goog.exportSymbol("M.control.Geosearchbylocation.RESULTS_TEMPLATE",M.control.Geosearchbylocation.RESULTS_TEMPLATE);goog.exportSymbol("M.impl.control.Geosearchbylocation",M.impl.control.Geosearchbylocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"setMap",M.impl.control.Geosearchbylocation.prototype.setMap);
goog.exportProperty(M.impl.control.Geosearch.prototype,"locate",M.impl.control.Geosearch.prototype.locate);goog.exportProperty(M.impl.control.Geosearch.prototype,"removeLocate",M.impl.control.Geosearch.prototype.removeLocate);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"drawLocation",M.impl.control.Geosearchbylocation.prototype.drawLocation);goog.exportProperty(M.impl.control.Geosearchbylocation.prototype,"addResultsContainer",M.impl.control.Geosearchbylocation.prototype.addResultsContainer);
