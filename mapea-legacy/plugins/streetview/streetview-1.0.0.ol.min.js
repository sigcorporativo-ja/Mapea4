...
M.plugin.Streetview.NAME="streetview";M.plugin.Streetview.prototype.equals=function(a){return a instanceof M.plugin.Streetview?!0:!1};P.impl={};P.impl.control={};P.impl.control.Streetview={};
...
function(a){myPano=new google.maps.StreetViewPanorama(a,{position:new google.maps.LatLng(0,0),pov:{heading:165,pitch:0},zoom:1});this.sv=new google.maps.StreetViewService};M.impl.control.Streetview.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.sv=null}})();goog.exportSymbol("M.plugin.Streetview",M.plugin.Streetview);goog.exportProperty(M.plugin.Streetview.prototype,"streetview",M.plugin.Streetview.prototype.streetview);goog.exportProperty(M.plugin.Streetview.prototype,"name",M.plugin.Streetview.prototype.name);goog.exportProperty(M.plugin.Streetview.prototype,"addTo",M.plugin.Streetview.prototype.addTo);goog.exportProperty(M.plugin.Streetview.prototype,"destroy",M.plugin.Streetview.prototype.destroy);goog.exportSymbol("M.plugin.Streetview.NAME",M.plugin.Streetview.NAME);
goog.exportProperty(M.plugin.Streetview.prototype,"equals",M.plugin.Streetview.prototype.equals);goog.exportSymbol("M.control.Streetview",M.control.Streetview);goog.exportProperty(M.control.Streetview.prototype,"createView",M.control.Streetview.prototype.createView);goog.exportProperty(M.control.Streetview.prototype,"manageActivation",M.control.Streetview.prototype.manageActivation);goog.exportProperty(M.control.Streetview.prototype,"closeStreetView",M.control.Streetview.prototype.closeStreetView);
goog.exportProperty(M.control.Streetview.prototype,"equals",M.control.Streetview.prototype.equals);goog.exportProperty(M.control.Streetview.prototype,"openStreetView",M.control.Streetview.prototype.openStreetView);goog.exportSymbol("M.control.Streetview.NAME",M.control.Streetview.NAME);goog.exportSymbol("M.control.Streetview.TEMPLATE",M.control.Streetview.TEMPLATE);goog.exportSymbol("M.control.Streetview.TEMPLATE_DIALOG",M.control.Streetview.TEMPLATE_DIALOG);
goog.exportSymbol("M.impl.control.Streetview",M.impl.control.Streetview);goog.exportProperty(M.impl.control.Streetview.prototype,"openStreetView",M.impl.control.Streetview.prototype.openStreetView);goog.exportProperty(M.impl.control.Streetview.prototype,"processSVData",M.impl.control.Streetview.prototype.processSVData);goog.exportProperty(M.impl.control.Streetview.prototype,"initializeStreetView",M.impl.control.Streetview.prototype.initializeStreetView);
