...
0;this.busqMunicipioClick_=this.busqMunicipio_=!1;this.searchingResult_=this.resultsContainer_.querySelector("div#m-autocomplete-results > div#m-searching-result-autocomplete");M.Plugin.call(this)};goog.inherits(M.plugin.Autocomplete,M.Plugin);M.plugin.Autocomplete.prototype.addTo=function(a){this.map_=a;goog.dom.classlist.add(this.target_,M.plugin.Autocomplete.CLASS);goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_);goog.events.listen(this.target_,goog.events.EventType.INPUT,
this.keyPress_,!1,this);goog.events.listen(this.target_,goog.events.EventType.KEYUP,this.hiddenAutocomplete_,!1,this)};M.plugin.Autocomplete.prototype.hiddenAutocomplete_=function(a){27===a.keyCode&&this.cancelSearch_(a)};M.plugin.Autocomplete.prototype.keyPress_=function(a){a.preventDefault();M.utils.isNullOrEmpty(this.timeoutKey_)||this.cancelSearch_(a);var b=this.target_.value.trim();b.length>=this.minLength_&&(this.timeoutKey_=setTimeout(goog.bind(function(){-1!=b.indexOf(",")?this.busqMunicipio_=
!0:this.busqMunicipioClick_=this.busqMunicipio_=!1;this.search_(b)},this),this.delayTime_))};M.plugin.Autocomplete.prototype.search_=function(a,b){var c=this;this.evt=b;var d;d=M.utils.addParameters(this.url_,{input:a.trim(),limit:this.limit_,codine:this.locality_});d=this.formatContent_(d," ","%20");this.searchTime_=Date.now();(function(b){M.remote.get(d).then(function(d){if(b===c.searchTime_){d=JSON.parse(d.text);d=c.parseResultsForTemplate_(d);var e=c.map_.getControls();if(M.utils.isUndefined(d.docs)){d=
0;for(var f=e.length;d<f;d++)"searchstreet"===e[d].name_?e[d].completed=!1:"searchstreetgeosearch"===e[d].name_&&(e[d].ctrlSearchstreet.completed=!1)}else if(M.utils.isUndefined(d.docs[0]))for(d=0,f=e.length;d<f;d++)"searchstreet"===e[d].name_?e[d].completed=!1:"searchstreetgeosearch"===e[d].name_&&(e[d].ctrlSearchstreet.completed=!1);else M.template.compile(M.plugin.Autocomplete.RESULTAUTOCOMPLETE,{jsonp:!0,vars:d}).then(function(b){c.resultsContainer_.innerHTML=b.innerHTML;c.addEvents_(c.resultsContainer_.querySelectorAll("div.autocomplete"));
...
this.minLength_=this.url_=null};M.plugin.Autocomplete.CLASS="m-plugin-autocomplete";M.plugin.Autocomplete.SEARCHING_CLASS="m-searching";M.plugin.Autocomplete.RESULTAUTOCOMPLETE="resultautocomplete.html";M.plugin.Autocomplete.MINIMUM="minimum";M.plugin.Autocomplete.prototype.equals=function(a){return a instanceof M.plugin.Autocomplete?!0:!1};M.plugin.Autocomplete.NAME="autocomplete"})();goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"zoomResults",M.impl.control.SearchstreetGeosearch.prototype.zoomResults);goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"destroy",M.impl.control.SearchstreetGeosearch.prototype.destroy);goog.exportSymbol("M.plugin.SearchstreetGeosearch",M.plugin.SearchstreetGeosearch);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"name",M.plugin.SearchstreetGeosearch.prototype.name);
goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"addTo",M.plugin.SearchstreetGeosearch.prototype.addTo);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"destroy",M.plugin.SearchstreetGeosearch.prototype.destroy);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"equals",M.plugin.SearchstreetGeosearch.prototype.equals);goog.exportSymbol("M.impl.control.SearchstreetIntegrated",M.impl.control.SearchstreetIntegrated);
goog.exportProperty(M.impl.control.SearchstreetIntegrated.prototype,"addTo",M.impl.control.SearchstreetIntegrated.prototype.addTo);goog.exportProperty(M.impl.control.SearchstreetIntegrated.prototype,"zoomResults",M.impl.control.SearchstreetIntegrated.prototype.zoomResults);goog.exportSymbol("M.control.SearchstreetGeosearch",M.control.SearchstreetGeosearch);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"ctrlSearchstreet",M.control.SearchstreetGeosearch.prototype.ctrlSearchstreet);
