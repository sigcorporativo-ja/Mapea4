...
this.url_=this.panel_=this.autocompletador_=this.control_=this.map_=this.name=null};M.plugin.Searchstreet.prototype.equals=function(a){return a instanceof M.plugin.Searchstreet?!0:!1}})();P.control={};P.control.Searchstreet={};
...
"top-extra");this.removePoints_();this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.listPoints=this.facadeMap_=null};M.impl.control.Searchstreet.POPUP_TEMPLATE="searchstreetpopup.html"})();goog.exportSymbol("M.plugin.Searchstreet",M.plugin.Searchstreet);goog.exportProperty(M.plugin.Searchstreet.prototype,"name",M.plugin.Searchstreet.prototype.name);goog.exportProperty(M.plugin.Searchstreet.prototype,"addTo",M.plugin.Searchstreet.prototype.addTo);goog.exportProperty(M.plugin.Searchstreet.prototype,"destroy",M.plugin.Searchstreet.prototype.destroy);goog.exportProperty(M.plugin.Searchstreet.prototype,"equals",M.plugin.Searchstreet.prototype.equals);
