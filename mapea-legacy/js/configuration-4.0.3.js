...
(function (M) {
    ...
    * @api stable
    */
   M.config('PROXY_URL', 'http://mapea4-sigc.juntadeandalucia.es/mapea/api/proxy');
    ...
    * @api stable
    */
   M.config('PROXY_POST_URL', 'http://mapea4-sigc.juntadeandalucia.es/mapea/proxyPost');
   ...
   M.config('predefinedWMC', {
       ...
       * @api stable
       */
      'names': 'Callejero,Hibrido,Satelite,mapa callejero cache,mapa del callejero,mapa idea,mapa ortofoto09,Callejero,Ortofoto,Híbrido,mapa ortofoto'.split(',')
   });
