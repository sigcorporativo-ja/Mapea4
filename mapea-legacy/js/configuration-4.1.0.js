...
(function (M) {
    ...
    * @api stable
    */
   M.config('MAPEA_URL', 'http://publicacion.i-administracion.junta-andalucia.es/mapea');
    ...
    * @api stable
    */
   M.config('PROXY_URL', 'http://publicacion.i-administracion.junta-andalucia.es/mapea/api/proxy');
    ...
    * @api stable
    */
   M.config('THEME_URL', 'http://publicacion.i-administracion.junta-andalucia.es/mapea/assets/');
   ...
   M.config('predefinedWMC', {
       ...
       * @api stable
       */
      'urls': 'http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/context_cdau_callejero.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/context_cdau_hibrido.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/context_cdau_satelite.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/contextCallejeroCache.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/contextCallejero.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/contextIDEA.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/contextOrtofoto2009.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/callejero2011cache.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/ortofoto2011cache.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/hibrido2011cache.xml,http://publicacion.i-administracion.junta-andalucia.es/mapea/files/wmc/contextOrtofoto.xml'.split(','),
