 ...
 * @api stable
 */
M.impl.interaction.SelectCluster.prototype.selectCluster = function (e)
{	// Nothing selected
 ...
 * @api stable
 */
M.impl.interaction.SelectCluster.prototype.animateCluster_ = function(center)
{	// Stop animation (if one is running)
	...
	let stylefn = (typeof(style) == 'function') ? style : style.length ? function(){ return style; } : function(){ return [style]; } ;
	...
	{	let vectorContext = event.vectorContext;
		...
		for (let i=0; i < features.length; i++) if (features[i].get('features'))
