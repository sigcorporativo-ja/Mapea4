...
public class iFrame {
	...
	@ApiOperation(value = " ", notes = "Mapea puede ser integrado en paǵinas web mediante el uso de iframes. A través del API REST se puede incluir un visualizador interactivo en cualquier página web sin necesidad de disponer de conocimientos específicos en programación ni en el ámbito de los SIG. Para ello únicamente es necesario que el usuario configure el mapa a visualizar a través de una URL:\n"
			+ "\n"
			+ "https://mapea4-sigc.juntadeandalucia.es/?wmcfile=callejero,cdau_satelite&controls=mouse,layerswitcher,overviewmap,scaleline,location&layers=WMS\\*Redes\\*https://www.ideandalucia.es/wms/mta400v_2008?\\*Redes_energeticas\\*true&getfeatureinfo=html\n"
	...
	public String iframe(
			...
			@ApiParam(value = "wmcfile indica el/los ficheros WMC a cargar \n- url: url del WMC\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?wmcfile=https://www.callejerodeandalucia.es/wmc/context_cdau_callejero.xml*mapa,cdau_satelite", required = false) @QueryParam("wmcfile") String wmc,
			...
			@ApiParam(value = "indica el/las capas a cargar \n - tipoCapa: tipo capa OGC\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?layers=WMS\\*Municipios\\*https://www.ideandalucia.es/wms/dea100_divisiones_administrativas?\\*terminos_municipales\\*false\\*true", required = false) @QueryParam("layers") String layers,

			// Zoom
			@ApiParam(value = "nivel de zoom aplicado\n\n"
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?zoom=6", required = false) @QueryParam("zoom") String zoom,
			...
			@ApiParam(value = "coordenadas de centrado del mapa.  \n - coordX: coordenada X\n" + "- coordY: coordY\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?center=235061.9,4141933.04*true&zoom=6", required = false) @QueryParam("center") String center,
			// label
			@ApiParam(value = "cadena de texto que será visualizada como texto html en un popup en el centro del mapa o en las coordenadas indicadas mediante center \n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?label=texto_con_html", required = false) @QueryParam("label") String label,
			...
			@ApiParam(value = "encuadre de visualización del mapa \n" + "- minX: coordenada menor eje X\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?bbox=323020.1,4126873.2,374759.9,4152013.3", required = false) @QueryParam("bbox") String bbox,

			// maxextent
			@ApiParam(value = "máxima extensión permitida; a diferencia del bbox, no se dibujará el mapa fuera de los límites establecidos \n"
					+ "- minX: coordenada menor eje X\n" + "- minY: coordenada menor eje Y\n"
					+ "- maxX: coordenada mayor eje X\n" + "- maxY: coordenada mayor eje Y\n\n"
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?maxextent=323020.1,4126873.2,374759.9,4152013.3", required = false) @QueryParam("maxextent") String maxextent,
			...
			@ApiParam(value = "controles a incluir en el mapa \n"
					...
					+ "Más información en Controles básicos(httpss://github.com/sigcorporativo-ja/Mapea4/wiki/Controles-b%C3%A1sicos)\n\n"
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?controls=layerswitcher,overviewmap,mouse,panzoombar", required = false) @QueryParam("controls") String controls,
			...
			@ApiParam(value = "añade la herramienta de consulta \n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?controls=navtoolbar&layers=WMS\\*Capa2\\*https://www.ideandalucia.es/wms/mta400r_2008?\\*MTA400\\*false,WMS\\*Capa1*https://www.juntadeandalucia.es/medioambiente/mapwms/REDIAM_GeoParques?\\*GeoParques\\*true&getfeatureinfo=html", required = false) @QueryParam("getfeatureinfo") String getfeatureinfo,
			...
			@ApiParam(value = "permite configurar el sistema de referencia en el cual se visualiza el mapa.  \n"
					...
					+ "https://mapea4-sigc.juntadeandalucia.es/?layers=WMS\\*Capa%20wms\\*https://www.ideandalucia.es/wms/mta400r_2008?\\*MTA400\\*false&projection=EPSG:4326\\*d", required = false) @QueryParam("projection") String projection,
			...
			@ApiParam(value = "buscador de elementos espaciales a través de un servicio de Geobúsquedas. \n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?geosearch=https://geobusquedas-sigc.juntadeandalucia.es/\\*sigc\\*/search ", example = "", required = false) @QueryParam("geosearch") String geosearch,
			...
			@ApiParam(value = "buscador de elementos espaciales cercano a la posición del usuario\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?geosearchbylocation=500", required = false) @QueryParam("geosearchbylocation") String geosearchbylocation,
			...
			@ApiParam(value = "control para búsqueda de direcciones\n"
					...
					+ "Ejemplo: https://mapea4-sigc.juntadeandalucia.es/?searchstreet=41091", required = false) @QueryParam("searchstreet") String searchstreet) {
